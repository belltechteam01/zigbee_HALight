...
typedef struct haOnOffLightAttrsRAM_tag {
  ...
  zclIdentifyAttrsRAM_t         identifyAttrs;  /* RAM attributes from the Identify Cluster */
  zclOnOffAttrsRAM_t            onOffAttrs;     /* RAM attributes from the on/off cluster */
  zclGroupAttrsRAM_t            groupAttrs;     /* RAM attributes from the group cluster */  
#if gZclEnablePollControlCluster_d && (gEndDevCapability_d || gComboDeviceCapability_d)
  zclPollControlAttrsRAM_t      pollControl;    /* RAM attributes from the poll control cluster */
#endif  
...
typedef struct zllColorLightAttrsRAM_tag {
  uint8_t  reportMask[1];        /* allows up to 8 reportable attributes in this node  */
  zclBasicAttrsRAM_t            basicAttrs;     /* RAM attributes from the Basic cluster */  
  zclIdentifyAttrsRAM_t         identifyAttrs;  /* RAM attributes from the Identify Cluster */
  zclOnOffAttrsRAM_t            onOffAttrs;     /* RAM attributes from the on/off cluster */
  zclGroupAttrsRAM_t            groupAttrs;     /* RAM attributes from the group cluster */  
  zclLevelCtrlAttrsRAM_t        levelCtrlAttrs; /* RAM attributes from the level control cluster */
  zclColorCtrlAttrsRAM_t        colorCtrlAttrs; /* RAM attributes from the color control cluster */     
} zllColorLightAttrsRAM_t;

/******************************
* ColorController
*******************************/

/* color Controller structure */
typedef struct zllColorControllerAttrsRAM_tag {
  uint8_t  reportMask[1];        /* allows up to 8 reportable attributes in this node  */
  zclBasicAttrsRAM_t            basicAttrs;     /* RAM attributes from the Basic cluster */  
  zclIdentifyAttrsRAM_t         identifyAttrs;  /* RAM attributes from the Identify Cluster */
} zllColorControllerAttrsRAM_t;

/******************************
  Combined Interface
*******************************/

/* combine interface structure */
typedef struct haCombinedInterfaceAttrsRAM_tag {
  uint8_t  reportMask[1];  /* allows up to 8 reportable endpoints in this node  */
  zclBasicAttrsRAM_t            basicAttrs;     /* RAM attributes from the Basic cluster */  
  zclIdentifyAttrsRAM_t         identifyAttrs;  /* RAM attributes from the Identify Cluster */
#if gZclEnablePollControlCluster_d && (gEndDevCapability_d || gComboDeviceCapability_d)
...
* WhiteGood Device 
*******************************/
typedef struct haWhiteGoodAttrRAM_tag {
  uint8_t                           reportMask[1];        /* allows up to 8 reportable endpoints in this node */
  zclPowerProfileAttrsRAM_t         pwrProfile;           /* Power Profile Attributes */
  zclApplianceControlAttrsRAM_t     applianceCtrl;        /* Appliance Control Attributes */ 
#if gZclEnableApplianceStatistics_d
  zclApplianceStatisticsAttrsRAM_t  applianceStatistics;  /* ApplianceStatistics Attributes*/
#endif
#if gZclEnablePartition_d  
  zclPartitionAttrs_t				partitionAttr;		  /* Partition Attributes */ 	
#endif  
} haWhiteGoodAttrRAM_t;

/******************************
* HomeGateway Device 
*******************************/
typedef struct haHomeGatewayAttrRAM_tag {
  uint8_t                       reportMask[1];  /* allows up to 8 reportable endpoints in this node */
  zclPowerProfileAttrsRAM_t     pwrPRofile;     /* Power Profile Attribute */
  zclApplianceControlAttrsRAM_t applianceCtrl;  /* Appliance Control Attribute */
} haHomeGatewayAttrRAM_t;
