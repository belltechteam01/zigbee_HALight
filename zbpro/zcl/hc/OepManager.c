...
*******************************************************************************
******************************************************************************/
  void HandleConnAssociatingState(tsEvent_t event);
/******************************************************************************
*******************************************************************************
...
*****************************************************************************/
void HandleDisconnectedState(tsEvent_t event) 
{
...
*****************************************************************************/
void HandleConnDissasociatingState(tsEvent_t event) 
{
...
void HandleConnUnassociatedState(tsEvent_t event) 
{
...
void HandleConnAssociatingState(tsEvent_t event) 
{
  ...
  {   
    ...
    (void)oepCsCreateAssociateRes(&managerBuffer[0], associateResult, (uint16_t*)&outMsg.length);
...
*****************************************************************************/
void HandleConnConnAssocOperatingState(tsEvent_t event) 
{
    ...
    {    
      ...
      {        
        ...
        {      
          ...
          (void)oepCsCreateDataResponse(&managerBuffer[0], (uint16_t*)&outMsg.length, invokeId);
...
#endif       
        (void)oepCsCreateRlrq(&managerBuffer[0], (uint16_t*)&outMsg.length, hcZtcSendAssocRelease->reason);
        // ZHCTODO - setting addresses needs to be factored
        outMsg.dstAddrMode = mManagerAddrInfo.dstAddrMode;
      ...
      else if (pApdu->choice == oepAssocChoice_SendGetMdsReq)
      {
        ...
        (void)oepCsCreateGetAllAtributesFrame(&managerBuffer[0], (uint16_t*)&outMsg.length, hcZtcSendGetMdsRequest->invokeId, 0);
        // ZHCTODO - setting addresses needs to be factored
        outMsg.dstAddrMode = mManagerAddrInfo.dstAddrMode;
      ...
      {
        (void)oepCsCreateRlre(&managerBuffer[0], (uint16_t*)&outMsg.length, pApdu->u.rlrq.reason);
        // ZHCTODO - setting addresses needs to be factored
        outMsg.dstAddrMode = mManagerAddrInfo.dstAddrMode;
        outMsg.dstEndPoint = mManagerAddrInfo.dstEndPoint;
        outMsg.aDstAddr[0] = mManagerAddrInfo.aDstAddr[0];
...
*****************************************************************************/
void HandleConnAssocConfWcState(tsEvent_t event) 
{
  apdu_t* pApdu = NULL;
  prstOepCfgRepApdu_t* pPrstApdu = NULL;
  OepOutgoingMessage_t outMsg;
    ...
    if (NULL != pCurrentFragApdu)
    {
      ...
      else if(pApdu->choice == gPrst_d)
      {
             ...
             )
          {
            ...
            /* Send ConfigEventReportResponse */
            (void)oepCsGenerateConfigRes(&managerBuffer[0],  (uint16_t*)&outMsg.length, pPrstApdu->invokeId,
...
void HandleConnAssocConfCcState(tsEvent_t event) 
{
