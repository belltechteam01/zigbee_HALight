...
typedef PACKED_STRUCT oepGenericApdu_tag {
  uint16_t  apduLen;
  uint16_t  choice;
  uint8_t   payload[1];
} oepGenericApdu_t;
...
typedef PACKED_UNION objectAttrData_tag
{  
  uint32_t   data32;  
  uint16_t   data16; 
  uint8_t    data8;
...
typedef PACKED_STRUCT objectAttribute_tag 
{ 
...
typedef PACKED_STRUCT genericClass_tag
{
  oidType_t   classId;
  oepHandle_t handle;
