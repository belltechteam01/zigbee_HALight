...
/*****************************************************************************
  ...
  On oepAssocChoice_StartOepAssocRec    
    ...
    - initiate association 
*****************************************************************************/
static void HandleDisconnectedState(tsEvent_t event) 
{
...
*****************************************************************************/
static void HandleConnDissasociatingState(tsEvent_t event) 
{   
...
*****************************************************************************/
static void HandleConnUnassociatedState(tsEvent_t event) 
{
      ...
      {       
        ...
        {        
          ...
          if (pApdu->payload[1] == oepStartAssocOrigin_EndDeviceBind)
            ZbTMR_StartTimer(mTimer, gTmrSingleShotTimer_c , 2000, OnTimeOut);
          else 
            sendAssocReq = TRUE;
        }                           
      }
  ...
  if (sendAssocReq || event & evtAssocReq_c) 
  {
    ...
    (void)oepCsCreateAssociateReq(&agentBuffer[0], (uint16_t*)&outMsg.length);
...
*****************************************************************************/
static void HandleConnAssociatingState(tsEvent_t event) 
{
  apdu_t* pApdu = NULL;
    ...
    if (NULL != pCurrentFragApdu)
    {
      ...
      else if(pApdu->choice == gAare_d)
      {
        ...
        case gAcceptedUnknownConfig_d:
          ...
          /* Send configuration */        
         (void)oepCsCreateReportConfig(&agentBuffer[0], (uint16_t*)&outMsg.length, 0x1234);
...
static void HandleConnConnAssocOperatingState(tsEvent_t event) 
{  
  ...
  if (event & evtApduReceived_c) 
  {
    ...
    {      
      ...
      {       
          ...
          (void)oepCsCreateDataReport(&agentBuffer[0], (uint16_t*)&outMsg.length, hcZtcSendDataReport->invokeId,
...
#endif       
        (void)oepCsCreateRlrq(&agentBuffer[0], (uint16_t*)&outMsg.length, hcZtcSendAssocRelease->reason);
      ...
      {
        (void)oepCsCreateRlre(&agentBuffer[0], (uint16_t*)&outMsg.length, gReleaseRequestReasonNormal_d);
      ...
      else if (pGenericApdu->choice == gPrst_d) 
      {
             ...
             )
          {
            ...
            (void)oepCsCreateGetMdsResponseFrame(&agentBuffer[0], (uint16_t*)&outMsg.length, invokeId);
...
*****************************************************************************/
static void HandleConnAssocConfWaState(tsEvent_t event) 
{
  apdu_t* pApdu = NULL;
...
*****************************************************************************/
/*
static void HandleConnAssocConfScState(tsEvent_t event) 
{
  (void) event;
