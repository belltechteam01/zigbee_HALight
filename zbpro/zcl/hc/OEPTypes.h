...
typedef PACKED_STRUCT oepType_tag 
{ 
  nomPartition_t partition; 
  oidType_t code; 
} oepType_t; 
 
typedef PACKED_STRUCT ava_tag 
{ 
  oidType_t attributeId; 
  any_t attributeValue; 
} ava_t; 
 
typedef PACKED_STRUCT attributeList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT attributeIdList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT highResRelativeTime_tag 
{ 
  uint8_t value[8]; 
} highResRelativeTime_t; 
 
typedef PACKED_STRUCT absoluteTimeAdjust_tag 
{ 
  uint8_t value[6]; 
} absoluteTimeAdjust_t; 
 
typedef PACKED_STRUCT absoluteTime_tag 
{ 
  uint8_t century; 
  uint8_t year; 
  uint8_t month; 
...
typedef PACKED_STRUCT octetString_tag
{ 
  uint16_t length; 
  uint8_t  value[1];    /* first element of the array */ 
} octetString_t; 
...
typedef PACKED_STRUCT systemModel_tag
{ 
...
typedef PACKED_STRUCT prodSpecEntry_tag 
{ 
  uint16_t specType; 
...
typedef PACKED_STRUCT productionSpec_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT batMeasure_tag 
{ 
  oepFloat_t value; 
  oidType_t unit; 
} batMeasure_t; 
...
#endif
typedef PACKED_STRUCT nuObsValue_tag
{ 
  oidType_t metricId; 
...
typedef PACKED_STRUCT nuObsValueCmp_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT sampleType_tag 
{ 
  uint8_t sampleSize; 
...
#endif
typedef PACKED_STRUCT saSpec_tag 
{ 
  uint16_t arraySize; 
...
typedef PACKED_STRUCT scaleRangeSpec8_tag
{ 
...
typedef PACKED_STRUCT scaleRangeSpec16_tag 
{ 
  oepFloat_t lowerAbsoluteValue; 
  oepFloat_t upperAbsoluteValue; 
...
typedef PACKED_STRUCT scaleRangeSpec32_tag 
{ 
...
typedef PACKED_STRUCT enumVal_tag 
{ 
  uint16_t choice; 
  uint16_t length; 
#if ( TRUE == gBigEndian_c )
...
typedef PACKED_STRUCT enumObsValue_tag
{ 
  oidType_t metricId; 
  measurementStatus_t state; 
  enumVal_t value; 
...
typedef PACKED_STRUCT attrValMapEntry_tag 
{ 
  oidType_t attributeId; 
  uint16_t attributeLen; 
} attrValMapEntry_t; 
 
typedef PACKED_STRUCT attrValMap_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT handleAttrValMapEntry_tag 
{ 
...
typedef PACKED_STRUCT handleAttrValMap_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
#endif
typedef PACKED_STRUCT setTimeInvoke_tag 
{ 
  absoluteTime_t dateTime; 
  oepFloat_t accuracy; 
} setTimeInvoke_t; 
 
typedef PACKED_STRUCT segmIdList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT absTimeRange_tag 
{ 
  absoluteTime_t fromTime; 
  absoluteTime_t toTime; 
} absTimeRange_t; 
 
typedef PACKED_STRUCT segmentInfo_tag 
{ 
...
typedef PACKED_STRUCT segmentInfoList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT segmSelection_tag 
{ 
  uint16_t choice; 
  uint16_t length; 
#if ( TRUE == gBigEndian_c )
...
#endif
typedef PACKED_STRUCT segmEntryElem_tag 
{ 
  oidType_t      classId; 
...
typedef PACKED_STRUCT segmEntryElemList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT pmSegmentEntryMap_tag 
{ 
  segmEntryHeader_t segmEntryHeader; 
  segmEntryElemList_t segmEntryElemList; 
} pmSegmentEntryMap_t; 
 
typedef PACKED_STRUCT segmElemStaticAttrEntry_tag 
{ 
oidType_t        classId; 
oepType_t        metricType; 
...
typedef PACKED_STRUCT pmSegmElemStaticAttrList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT trigSegmDataXferReq_tag 
{ 
  instNumber_t     segInstNo; 
...
typedef PACKED_STRUCT trigSegmDataXferRsp_tag 
{ 
  instNumber_t            segInstNo; 
...
#endif
typedef PACKED_STRUCT segmDataEventDescr_tag       
{ 
...
typedef PACKED_STRUCT segmentDataEvent_tag 
{ 
  segmDataEventDescr_t    segmDataEventDescr; 
  octetString_t           segmDataEventEntries; 
} segmentDataEvent_t; 
 
typedef PACKED_STRUCT segmentDataResult_tag 
{ 
  segmDataEventDescr_t      segmDataEventDescr; 
} segmentDataResult_t; 
...
typedef PACKED_STRUCT segmentStatisticEntry_tag 
{ 
  segmStatType_t          segmStatType; 
  octetString_t           segmStatEntry; 
} segmentStatisticEntry_t; 
 
typedef PACKED_STRUCT segmentStatistics_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT observationScan_tag 
{ 
  oepHandle_t objHandle; 
...
#endif
typedef PACKED_STRUCT uuidIdent_tag 
{ 
  uint8_t value[16]; 
} uuidIdent_t; 
...
typedef PACKED_STRUCT dataProto_tag 
{ 
  dataProtoId_t dataProtoId; 
  any_t dataProtoInfo; 
} dataProto_t; 
 
typedef PACKED_STRUCT dataProtoList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT aarqApdu_tag
{ 
...
#endif
typedef PACKED_STRUCT aareApdu_tag 
{ 
...
#define          gReleaseRequestReasonNormal_d        0 
#endif
typedef PACKED_STRUCT rlrqApdu_tag 
{ 
...
#define          gReleaseResponseReasonNormal_d        0 
#endif
typedef PACKED_STRUCT rlreApdu_tag 
{ 
...
typedef PACKED_STRUCT abrtApdu_tag 
{ 
...
typedef PACKED_STRUCT eventReportArgumentSimple_tag 
{ 
  oepHandle_t objHandle; 
...
typedef PACKED_STRUCT getArgumentSimple_tag
{ 
...
#endif
typedef PACKED_STRUCT attributeModEntry_tag 
{ 
  modifyOperator_t modifyOperator; 
  ava_t attribute; 
} attributeModEntry_t; 
 
typedef PACKED_STRUCT modificationList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT setArgumentSimple_tag 
{ 
  oepHandle_t objHandle; 
  modificationList_t modificationList; 
} setArgumentSimple_t; 
 
typedef PACKED_STRUCT actionArgumentSimple_tag 
{ 
  oepHandle_t objHandle; 
...
typedef PACKED_STRUCT eventReportResultSimple_tag 
{ 
  oepHandle_t objHandle; 
...
typedef PACKED_STRUCT getResultSimple_tag 
{ 
  oepHandle_t objHandle; 
  attributeList_t attributeList; 
} getResultSimple_t; 
 
typedef PACKED_STRUCT typeVer_tag 
{ 
  oidType_t type; 
  uint16_t version; 
} typeVer_t; 
 
typedef PACKED_STRUCT typeVerList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT setResultSimple_tag 
{ 
  oepHandle_t obj_handle; 
...
typedef PACKED_STRUCT actionResultSimple_tag 
{ 
  oepHandle_t objHandle; 
  oidType_t actionType; 
  any_t actionInfoArgs; 
...
typedef PACKED_STRUCT errorResult_tag 
{ 
...
#endif
typedef PACKED_STRUCT rejectResult_tag 
{ 
  rorjProblem_t problem; 
} rejectResult_t; 

 
typedef PACKED_STRUCT dataApdu_tag 
{ 
  invokeId_t invokeId; 
  PACKED_STRUCT 
  { 
...
typedef PACKED_STRUCT dataReqModeCapab_tag 
{ 
...
typedef PACKED_STRUCT phdAssociationInformation_tag 
{ 
...
typedef PACKED_STRUCT manufSpecAssociationInformation_tag 
{ 
...
#endif
typedef PACKED_STRUCT mdsTimeInfo_tag 
{ 
...
#endif
*/
typedef PACKED_STRUCT metricStructureSmall_tag 
{ 
   uint8_t msStruct; 
#if ( TRUE == gBigEndian_c )
...
typedef PACKED_STRUCT metricIdList_tag
{  
  uint16_t count;
  uint16_t length;
  oidType_t *value;  
...
typedef PACKED_STRUCT supplementalTypeList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT observationScanList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT scanReportPerVar_tag 
{ 
  uint16_t personId; 
  observationScanList_t obsScanVar; 
} scanReportPerVar_t; 
 
typedef PACKED_STRUCT scanReportPerVarList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
#endif
typedef PACKED_STRUCT scanReportInfoMPVar_tag 
{ 
...
typedef PACKED_STRUCT observationScanFixed_tag 
{ 
  oepHandle_t objHandle; 
  octetString_t obsValData; 
} observationScanFixed_t; 
 
typedef PACKED_STRUCT observationScanFixedList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT scanReportPerFixed_tag 
{ 
  uint16_t personId; 
  observationScanFixedList_t obsScanFix; 
} scanReportPerFixed_t;

 typedef PACKED_STRUCT scanReportPerFixedList_t 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT scanReportInfoMPFixed_tag 
{ 
  dataReqId_t dataReqId; 
  uint16_t scanReportNo; 
...
typedef PACKED_STRUCT scanReportInfoVar_tag 
{ 
  dataReqId_t dataReqId; 
  uint16_t scanReportNo; 
  observationScanList_t obsScanVar; 
...
typedef PACKED_STRUCT scanReportInfoFixed_tag 
{ 
  dataReqId_t dataReqId; 
  uint16_t scanReportNo; 
...
typedef PACKED_STRUCT scanReportInfoGroupedList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT scanReportInfoGrouped_t 
{ 
  dataReqId_t dataReqId; 
  uint16_t scanReportNo; 
...
typedef PACKED_STRUCT scanReportPerGrouped_tag 
{ 
  personId_t personId; 
  observationScanGrouped_t obsScanGrouped; 
} scanReportPerGrouped_t; 
 
typedef PACKED_STRUCT scanReportPerGroupedList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT scanReportInfoMPGrouped_tag 
{ 
  dataReqId_t dataReqId; 
  uint16_t scanReportNo; 
...
typedef PACKED_STRUCT configObject_tag 
{ 
  oidType_t objClass; 
  oepHandle_t objHandle; 
  attributeList_t attributes; 
...
typedef PACKED_STRUCT configObjectList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT configReport_tag 
{ 
...
#endif
typedef PACKED_STRUCT configReportRsp_tag 
{ 
  configId_t configReportId; 
...
#endif
typedef PACKED_STRUCT handleList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT dataRequest_tag 
{ 
  dataReqId_t id; 
  dataReqMode_t mode; 
  relativeTime_t time; 
...
#endif
typedef PACKED_STRUCT dataResponse_tag 
{ 
...
typedef PACKED_STRUCT simpleNuObsValueCmp_tag 
{ 
  uint16_t count; 
  uint16_t length; 
...
typedef PACKED_STRUCT basicValList_tag 
{ 
  uint16_t count; 
  uint16_t length; 
  oepSfloat_t *value;
...
***********************************************************/
typedef PACKED_STRUCT aarqOepApdu_tag
{ 
...
typedef PACKED_STRUCT aareOepApdu_tag 
{ 
  associateResult_t result; 
  dataProtoId_t dataProtoId;  /* This must be initialized to gDataProtoId_20601_d = 20601 = 0x5079 */
...
typedef PACKED_STRUCT prstOepCfgRepApdu_tag
{
...
typedef PACKED_STRUCT prstOepCfgRspApdu_tag
{
  uint16_t length;          /* Length of the reminder of the structure */
...
typedef PACKED_STRUCT prstOepDataReport_tag
{
  uint16_t length;          // Length of the reminder of the structure
  invokeId_t invokeId;      
  uint16_t choice;          // Must be set to gRoivCmipConfirmedEventReport_d = 0x0101
...
typedef PACKED_STRUCT prstOepDataRspApdu_tag
{
  uint16_t length;          // Length of the reminder of the structure
...
typedef PACKED_STRUCT prstOepGetFrame_tag
{
  uint16_t length;          // Length of the reminder of the structure
  invokeId_t invokeId;      // Must match the invokeId received in the data report
...
typedef PACKED_STRUCT apdu_tag 
{ 
  uint16_t choice; 
  uint16_t length; 
#if ( TRUE == gBigEndian_c )
