...
typedef PACKED_STRUCT Oep11073Cmd_Tag 
{
...
typedef PACKED_STRUCT Oep11073AddressInfo_Tag 
{
...
PACKED_STRUCT OepApduFragment_tag
{
  uint8_t len;                     /* length of Apdu fragment */
  PACKED_STRUCT OepApduFragment_tag *nextFragment; /* pointer to next fragment */
  uint8_t data[1];                 /* First byte of Apdu payload */  
};
typedef PACKED_STRUCT OepApduFragment_tag OepApduFragment_t;

typedef PACKED_STRUCT OepFragmentedApdu_tag 
{
...
typedef PACKED_STRUCT OepOutgoingMessage_tag
{
  bool_t ztcOnly;
...
typedef PACKED_STRUCT OepEndpointData_tag 
{      
  zbEndPoint_t ep;
