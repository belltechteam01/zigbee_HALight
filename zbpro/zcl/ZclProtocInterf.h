...
#define gZclAttrGTSet_c              0x00    /* Generic Tunnel Set Id */

#define gZclAttrIdGTMaxInTrsSize_c   0x01    /* M - Maximum IN transfer Size attributes Set */
#define gZclAttrIdGTMaxOutTrsSize_c  0x02    /* M - Maximum OUT transfer Size attributes Set */
#define gZclAttrIdGTProtoAddr_c      0x03    /* M - Protocol Address attributes Set */
...
typedef PACKED_STRUCT zclProtocolAddress_tag
{
  uint8_t      AddrLen;
  uint8_t      ProtocolAddress[gZclGtMaxProtocolAddress];
} zclProtocolAddress_t;

typedef PACKED_STRUCT zclCmdGtMpa_tag 
{
...
typedef PACKED_STRUCT zclCmdGtMpaRes_tag 
{
  afAddrInfo_t addrInfo;
}zclCmdGtMpaRes_t;


typedef PACKED_STRUCT zclCmdGtAdvertiseProtoAddr_tag 
{
  afAddrInfo_t addrInfo;
  zclProtocolAddress_t protocolAddress;
...
#define gZclAttr11703ProtocTunnelSet               0x00 

#define gZclAttrId11703ProtocTunnelDeviceIdList_c    0x00  /* M - Device ID List */
#define gZclAttrId11703ProtocTunnelManagerTarget_c   0x01
#define gZclAttrId11703ProtocTunnelManagerEndpoint_c 0x02
#define gZclAttrId11703ProtocTunnelConnected_c       0x03
#define gZclAttrId11703ProtocTunnelPreemptible_c     0x04
#define gZclAttrId11703ProtocTunnelIdleTimeout_c     0x05
...
typedef PACKED_STRUCT zclApdu_tag
{
  uint16_t apduLen;
  uint8_t  apdu[1];  
}
...
typedef PACKED_STRUCT zclCmd11073_TransferApdu_tag 
{
  afAddrInfo_t addrInfo;
  zclApdu_t    apdu;
}
...
/* Transfer APDU command */
typedef PACKED_STRUCT zclCmd11073_TransferApduPtr_tag 
{
  afAddrInfo_t addrInfo;
  zclApdu_t*   apdu;
}
...
typedef PACKED_STRUCT  zclCmd11073_ConnectRequestParams_tag {
...
typedef PACKED_STRUCT  zclCmd11073_ConnectRequest_tag {
  afAddrInfo_t addrInfo;
  zclCmd11073_ConnectRequestParams_t params;
} zclCmd11073_ConnectRequest_t;

typedef PACKED_STRUCT  zclCmd11073_DisconnectRequest_tag {
  afAddrInfo_t addrInfo;
  uint8_t ieeeAddress[8];
...
typedef PACKED_STRUCT  zclCmd11073_ConnectStatusNotif_tag {
  afAddrInfo_t addrInfo;
  zclCmd11073_ConnectStatus_t connectStatus;
} zclCmd11073_ConnectStatusNotif_t;

typedef PACKED_STRUCT zclGenericAppAttrRAM_tag
{
...
extern const zclAttrSetList_t gGtClusterAttrSetList;
extern const zclAttrDef_t gaGtClusterAttrDef[];
extern const zclAttrDef_t ga11073TunnelClusterAttrDef[];
extern const zclAttrSetList_t g11073TunnelClusterAttrSetList;
