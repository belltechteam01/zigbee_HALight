...
const zclAttrDef_t gaGtClusterAttrDef[] = {
  {gZclAttrIdGTMaxInTrsSize_c,  gZclDataTypeUint16_c,    gZclAttrFlagsInRAM_c|gZclAttrFlagsRdOnly_c, sizeof(int16_t), (void *)MbrOfs(zclGenericAppAttrRAM_t,maxInTrsSize)},
  {gZclAttrIdGTMaxOutTrsSize_c, gZclDataTypeUint16_c,    gZclAttrFlagsInRAM_c|gZclAttrFlagsRdOnly_c, sizeof(int16_t), (void *)MbrOfs(zclGenericAppAttrRAM_t,maxOutTrsSize)},
  {gZclAttrIdGTProtoAddr_c,     gZclDataTypeOctetStr_c, gZclAttrFlagsInRAM_c, gZclGtMaxProtocolAddress, (void *)MbrOfs(zclGenericAppAttrRAM_t,protocolAddress)}
};

const zclAttrSet_t gGtClusterAttrSet[] = {
  {gZclAttrGTSet_c, (void *)&gaGtClusterAttrDef, NumberOfElements(gaGtClusterAttrDef)}
};

const zclAttrSetList_t gGtClusterAttrSetList = {
  NumberOfElements(gGtClusterAttrSet),
  gGtClusterAttrSet
};

const zclCmd_t gaZclGeneralTunelClusterCmdReceivedDef[]={
  /* commands received */
  gZclCmdRxGTMpa_c 
};
const zclCmd_t gaZclGeneralTunelClusterCmdGeneratedDef[]={
  /* commands generated */
  gZclCmdTxGTMpaRes_c,
  gZclCmdTxGTAdvertiseProtoAddr_c
};

const zclCommandsDefList_t gaZclGeneralTunelClusterCommandsDefList =
{
   NumberOfElements(gaZclGeneralTunelClusterCmdReceivedDef), gaZclGeneralTunelClusterCmdReceivedDef,
   NumberOfElements(gaZclGeneralTunelClusterCmdGeneratedDef), gaZclGeneralTunelClusterCmdGeneratedDef
};



const zclAttrDef_t ga11073TunnelClusterAttrDef[] = {  
  {gZclAttrId11703ProtocTunnelDeviceIdList_c, gZclDataTypeArray_c, gZclAttrFlagsInRAM_c|gZclAttrFlagsRdOnly_c, sizeof(uint8_t) + sizeof(uint16_t)+sizeof(int16_t), (void *)MbrOfs(zclGenericAppAttrRAM_t,deviceIDList)},
  {gZclAttrId11703ProtocTunnelManagerTarget_c, gZclDataTypeIeeeAddr_c, gZclAttrFlagsInRAM_c|gZclAttrFlagsRdOnly_c, 8, (void *)MbrOfs(zclGenericAppAttrRAM_t,managerTarget)},
  {gZclAttrId11703ProtocTunnelManagerEndpoint_c, gZclDataTypeUint8_c, gZclAttrFlagsInRAM_c|gZclAttrFlagsRdOnly_c, 1, (void *)MbrOfs(zclGenericAppAttrRAM_t,managerEndpoint)},
  {gZclAttrId11703ProtocTunnelConnected_c, gZclDataTypeBool_c, gZclAttrFlagsInRAM_c|gZclAttrFlagsRdOnly_c, 1, (void *)MbrOfs(zclGenericAppAttrRAM_t,connected)},
  {gZclAttrId11703ProtocTunnelPreemptible_c, gZclDataTypeBool_c, gZclAttrFlagsInRAM_c|gZclAttrFlagsRdOnly_c, 1, (void *)MbrOfs(zclGenericAppAttrRAM_t,preemtible)},        
  {gZclAttrId11703ProtocTunnelIdleTimeout_c, gZclDataTypeUint16_c, gZclAttrFlagsInRAM_c|gZclAttrFlagsRdOnly_c, sizeof(uint16_t), (void *)MbrOfs(zclGenericAppAttrRAM_t,idleTimeout)}
};

const zclAttrSet_t g11703ProtocTunnelAttrSet[] = {
  {gZclAttr11703ProtocTunnelSet, (void *)&ga11073TunnelClusterAttrDef, NumberOfElements(ga11073TunnelClusterAttrDef)}
};

const zclAttrSetList_t g11073TunnelClusterAttrSetList = {
  NumberOfElements(g11703ProtocTunnelAttrSet),
  g11703ProtocTunnelAttrSet
};

const zclCmd_t gaZcl11073TunnelClusterCmdReceivedDef[]={
  /* commands received */
  gZclCmdRx11073_TransferAPDU_c,
  gZclCmdRx11073_ConnectRequest_c,
  gZclCmdRx11073_DisconnectRequest_c,
  gZclCmdRx11073_ConnectStatusNotif_c
};
//const zclCmd_t gaZcl11073TunnelClusterCmdGeneratedDef[];

const zclCommandsDefList_t gaZcl11073TunnelClusterCommandsDefList =
{
   NumberOfElements(gaZcl11073TunnelClusterCmdReceivedDef), gaZcl11073TunnelClusterCmdReceivedDef,
   0, NULL
};
...
) 
{
  ...
  #endif 
    endPointDesc_t *pEndpointDesc = EndPointConfigData(endPointList[i].pEndpointDesc);
    if(pEndpointDesc) {
      uint8_t endPoint;
      ...
      if(IsEqual2Bytes(pSimpleDesc->aAppProfId, ProfileId)) {
        pDeviceParams = (zclGenericAppAttrRAM_t*)((afDeviceDef_t *)EndPointConfigData(endPointList[i].pDevice))->pData;
        ...
        if (pDeviceParams->idleTimer == timer) {
          ...
          /* kill the timer */
          ZbTMR_FreeTimer(pDeviceParams->idleTimer);
...
) 
{
  ...
  zbTmrTimerID_t timerId = pDeviceParams->idleTimer;

  if (timerId != gTmrInvalidTimerID_c) {
    if (!killTimer) {
      idleTimeout = OTA2Native16(pDeviceParams->idleTimeout);
      ZbTMR_StartMinuteTimer(timerId, idleTimeout, ZCL_11073IdleTimerCallback);
    }
    else {
...
OepFragmentedApdu_t *GetApduFromIndication(zbApsdeDataIndication_t *pIndication, zclApdu_t *pTunnelApdu)
{
  ...
  */
  ...
  if (bytesNeeded <= gSmallMsgSize_d)
    fragmentedApdu = (OepFragmentedApdu_t*)MSG_Alloc(gSmallMsgSize_d);
  else
  ...
  while (nextFrag != NULL) {
    ...
    if (bytesNeeded <= gSmallMsgSize_d)
      fragment = (OepApduFragment_t*)MSG_Alloc(gSmallMsgSize_d);
    else
      fragment = (OepApduFragment_t*)MSG_Alloc(gMaxPacketBufferSize_c);
    
    if(!fragment)
    {
      OepFreeFragmentedApdu(fragmentedApdu);
      return NULL;
    }
...
)
{
  ...
  (void)ZCL_GetAttribute(pReq->addrInfo.srcEndPoint, ClusterId, gZclAttr11703ProtocTunnelConnected_c, gZclServerAttr_c, 
...
)
{
    ...
    {        
        case gZclCmdRxGTMpa_c:
        {
          ...
          (void)ZCL_GetAttribute(pIndication->dstEndPoint, ClusterId, gZclAttrGTProtoAddr_c, gZclServerAttr_c, &ProtocolAddress, &ProtocolAddressLen);
...
)
{
  ...
  if (pEndpointData->connected) {
    ...
    if (pEndpointData->idleTimer != gTmrInvalidTimerID_c && pConnectRequest->idleTimeout != gZclInvalidIdleTimer_c)
      ZbTMR_StartMinuteTimer(pEndpointData->idleTimer, OTA2Native16(pConnectRequest->idleTimeout), ZCL_11073IdleTimerCallback);
