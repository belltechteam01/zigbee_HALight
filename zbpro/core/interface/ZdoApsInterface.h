...
enum {
  gZdoEvent_Unused_c = 0x00,             // indicates event has been processed
...
#define ZDO_GetEvent()  ( ZbZdoPrivateData(gZdoEvent) )
void ZDO_SendEvent(ZdoEvent_t event);

/*
  start modes (see 053474r20 ZigBee Pro spec, section 2.5.5.5)
...
#define ZDO_GetStartMode()            ( ZbZdoPublicData(gZdoStartMode) & gZdoStartMode_StartMask_c)
#define ZDO_SetStartMode(mode)        ( ZbZdoPublicData(gZdoStartMode) = ( ZbZdoPublicData(gZdoStartMode) & (~gZdoStartMode_StartMask_c)) | (mode))
#define ZDO_GetPreferredDevType()     ( ZbZdoPublicData(gZdoStartMode) & gZdoStartMode_ComboMask_c)
#define ZDO_SetPreferredDevType(type) ( ZbZdoPublicData(gZdoStartMode) = ( ZbZdoPublicData(gZdoStartMode) & (~gZdoStartMode_ComboMask_c)) | (type))
#define ZDO_GetStartupSet()           ( ZbZdoPublicData(gZdoStartMode) & gZdoStartMode_SetMask_c)
#define ZDO_SetStartupSet(set)        ( ZbZdoPublicData(gZdoStartMode) = ( ZbZdoPublicData(gZdoStartMode) & (~gZdoStartMode_SetMask_c)) | (set))
...
#define ZDO_GetJoinMode() ZbZdoPrivateData(gZDOJoinMode)
...
#define ZDO_Stopped() (ZbZdoPrivateData(gZdoState == gZdoState_InitialState_c)

/* ZDO has fully started the network (all done) */
#define ZDO_Started() (ZbZdoPrivateData(gZdoState == gZdoState_RunningState_c)
...
#define ZDO_GetState()  ( ZbZdoPrivateData(gZdoState) )
#define ZDO_SetState(state) ( ZbZdoPrivateData(gZdoState) = (state) )
...
typedef PACKED_UNION apsmePayload_tag
{
...
typedef PACKED_STRUCT zbApsmeRedirectCmdReq_tag
{
...
typedef PACKED_UNION msgReq_tag
{
  zbApsmeTransportKeyReq_t  transportKeyReq;
}msgReq_t;

typedef PACKED_STRUCT zbApsmeTunnelReq_tag
{
...
typedef PACKED_STRUCT apsmeMessage_tag {
  primZdoToApsme_t msgType;
  PACKED_UNION {
...
* create a transport-key command packet (see 053474r20 ZigBee Pro spec sub-clause 4.4.9.2).
*
* Interface assumptions:
...
/*******************************************************************************
* challengeIsAccepted (053474r20 ZigBee Pro spec section B.4 Challenge Validation Primitive)
*
...
/************************************************************************************
* 053474r20 ZigBee Pro spec Sec. - 4.4.2.6.1 Generating and Sending the Initial SKKE-1 Frame
...
/*****************************************************************************
* This function returns TRUE if a SE packet is encrypted with the preconfigured 
  TC link key.
*****************************************************************************/
bool_t SeSecurityCheck(uint8_t frameControl, uint8_t *pProfileId, uint8_t *pSrcAddress);
