 ...
 ******************************/
/* This macro helps to store the number of active endpoints 
   for each Discovery requet field, can be 
   adjust or change to handle dinamic storage */
#ifndef  gMaximumActiveEPStoredList_c  
  #define  gMaximumActiveEPStoredList_c      3  
#endif

/* This macro helps to store the number of simple descriptors
   for each Active EP in the Discovery request field, can be 
   adjust or chege to handle dinamic sotrage
   and there is one or each Active EP */

#ifndef  gMaximumSimpleDescriptorList_c  
  #define  gMaximumSimpleDescriptorList_c      3 
#endif

/* This macro helps to set the right size for 
   the storing table in the Discovery Cache Device */
#ifndef  gMaximumDiscoveryStoreTableSize_c  
  #define  gMaximumDiscoveryStoreTableSize_c      2
#endif

#ifndef  gMaximumInClusterStore_c 
  #define  gMaximumInClusterStore_c      6
#endif

#ifndef  gMaximumOutClusterStore_c 
...
typedef PACKED_STRUCT sChannelMasterStatistics_tag
{
  uint8_t reason;
...
typedef PACKED_STRUCT routingTableList_tag
{
...
typedef PACKED_STRUCT zbMgmtRtgResponse_tag
{
  zbStatus_t  status;
...
/*********************/
typedef PACKED_STRUCT zbSystemServerDiscoveryStore_tag
{
...
/***********************************/
typedef PACKED_STRUCT cSimpleDescriptor_tag
{
  /*End point ID */
...
typedef PACKED_STRUCT discoveryStoreTable_tag  /* mn */
{
...
typedef PACKED_STRUCT holdBindingInfo_tag
{
...
/*Security */
/********************/
typedef PACKED_STRUCT zdoApsmeEstKeyReq_tag
{
...
typedef PACKED_STRUCT zdoApsmeEstKeyResp_tag
{
...
/**********************/
 ...
 typedef PACKED_STRUCT tcMasterKeyMat_tag
{
...
typedef PACKED_STRUCT nwkKeyMat_tag{
...
typedef PACKED_STRUCT appKeyMat_tag{
  uint8_t aKey[16];
...
typedef PACKED_STRUCT zdoApsmeTranspKeyReq_tag{
  uint8_t keyType;
  PACKED_UNION{
...
typedef PACKED_STRUCT zdoApsmeSwitchKeyReq_tag{
  uint8_t aDestLongAddr[8];
  uint8_t keySeqNumber;
}zdoApsmeSwitchKeyReq_t;

typedef PACKED_STRUCT zdoApsmeRequestKeyReq_tag{
  uint8_t aDestLongAddr[8];
  uint8_t keyType;
  uint8_t aPartnerLongAddr[8];
}zdoApsmeRequestKeyReq_t;

typedef PACKED_STRUCT zdoApsmeRemoveDevReq_tag{
  uint8_t aParentLongAddr[8];
  uint8_t aChildLongAddr[8];
}zdoApsmeRemoveDevReq_t;

typedef PACKED_STRUCT zdoApsmeUpdateDevReq_tag{
  uint8_t aDestLongAddr[8];
...
typedef PACKED_STRUCT zdoEstablishKeyInd_tag{
  uint8_t aInitLongAddr[8];
  uint8_t keyEstMethod;
}zdoEstablishKeyInd_t;

typedef PACKED_STRUCT zdoEstablishKeyConf_tag{
  uint8_t aPartnerLongAddr[8];
  uint8_t status;
}zdoEstablishKeyConf_t;

typedef PACKED_STRUCT zdoRemoveDeviceInd_tag{
 uint8_t aSrcLongAddr[8];
 uint8_t aChildLongAddr[8];
}zdoRemoveDeviceInd_t;

typedef PACKED_STRUCT zdoRequestKeyInd_tag{
  uint8_t aSrcLongAddr[8];
  uint8_t keyType;
  uint8_t aPartnerLongAddr[8];
}zdoRequestKeyInd_t;

typedef PACKED_STRUCT zdoSwitchKeyInd_tag{
  uint8_t aSrcLongAddr[8];
  uint8_t keySeqNum;
}zdoSwitchKeyInd_t;

typedef PACKED_STRUCT nwkKeyDataInd_tag{
   uint8_t aNetworkKey[16];
   uint8_t keySeqNum;
}nwkKeyDataInd_t;

 typedef PACKED_STRUCT masterLinkKeyInd_tag{
  uint8_t aKey[16];
  uint8_t aPartnerLongAddr[8];
  bool_t  initiator;
 }masterLinkKeyInd_t;

typedef PACKED_STRUCT  zdoTransportKeyInd_tag{
  uint8_t aSrcLongAddr[8];
  uint8_t keyType;
  PACKED_UNION{
...
typedef PACKED_STRUCT zdoUpdateDeviceInd_tag{
 uint8_t aSrcLongAddr[8];
 uint8_t aDeviceLongAddr[8];
 uint8_t aDeviceShortAddr[2];
 uint8_t status;
...
typedef PACKED_STRUCT zdoNwkDiscoveryReq_tag
{
...
typedef PACKED_STRUCT zdoNwkDiscoveryConf_tag
{
...
typedef PACKED_STRUCT zdoNwkDirectJoinReq_tag
{
...
typedef PACKED_STRUCT zdoNwkPermitJoinReq_tag
{
...
typedef PACKED_STRUCT zdoNwkDirectJoinConf_tag
{
  uint8_t aDeviceAddr[8];
  uint8_t status;
...
typedef PACKED_STRUCT zdoNwkSyncReq_tag
{
    bool_t track;
...
typedef PACKED_STRUCT zdoNwkSyncInd_tag
{
...
typedef PACKED_STRUCT ZdoNwkSyncConf_tag
{
  uint8_t    status;

}ZdoNwkSyncConf_t;

typedef PACKED_STRUCT zdpNlmeSyncReq_tag
{
  bool_t track;
}zdpNlmeSyncReq_t;

typedef PACKED_STRUCT zdoNlmeNetworkDiscoveryReq_tag
{
  uint8_t  aScanChannels[4];
  uint8_t  scanDuration;
...
typedef PACKED_STRUCT appToZdpMessage_tag{
...
typedef PACKED_STRUCT appToNwkMessage_tag{
...
typedef PACKED_STRUCT zdpToAppMessage_tag
...
typedef PACKED_STRUCT zdpRecordDiscCacheSuccess_tag
{
  zbNwkAddr_t  aNwkAddress;
...
typedef PACKED_STRUCT zdpRecordFindNodeSuccess_tag
{
...
enum {
  ...
  gZDOToAppMgmtJoinNwkFailed_c	    = 0x15,
  gZDOToApp_EndEvent                       /* used to initialize the next set of system events */
};
