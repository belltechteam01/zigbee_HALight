...
#define PWR_NODEPOWER_LEVEL_CRITICAL 0x00
#define PWR_NODEPOWER_LEVEL_33 0x40
#define PWR_NODEPOWER_LEVEL_66 0x80
#define PWR_NODEPOWER_LEVEL_100 0xc0
...
)
{
  if (pZdpAppCallBackPtr == NULL)
   ...
   ZbZdoPublicData(gpZdpAppCallBackPtr) = pZdpAppCallBackPtr;
}
...
/* Test code */
  switch (clusterId)
  {
    ...
    case gIEEE_addr_rsp_c:
      ...
      if (((zbAddressResponse_t *)pMsg)->status == gZbSuccess_c)
      {
        ...
        */
        if (ZDP_GetIndexMachineProcessQueue(gBind_req_c, ZbZdoPrivateData(gZdpResponseCounter)) != gZdoNoEntry_c)
        {
          /* This network address request was orginated by the Bind process the application does not need to know about it */
          MSG_Free(pMsgIn);
          ZDP_StateMachine(gBind_req_c,ZbZdoPrivateData(gZdpResponseCounter));
    ...
    case gDiscovery_Cache_rsp_c:
      if (!ZbZdoPrivateData(gDiscoveryCacheResponse))
      {
        if (((zbDiscoveryCacheResponse_t *)pMsg)->status == gZbSuccess_c)
        {
          Copy2Bytes(ZbZdoPrivateData(gDiscoveryCacheSuccess.aNwkAddress), aSrcAddr);
          ZbZdoPrivateData(gDiscoveryCacheResponse) = TRUE;
        }
        else
          ZbZdoPrivateData(gDiscoveryCacheResponse) = FALSE;
      }
    break;
#endif
    ...
    case gFind_node_cache_rsp_c:
      Copy2Bytes(ZbZdoPrivateData(gFindNodeCacheSuccess.aCacheNwkAddress), ((zbFindNodeCacheResponse_t *)pMsg)->aCacheNwkAddr);
      Copy2Bytes(ZbZdoPrivateData(gFindNodeCacheSuccess.aNwkAddress), ((zbFindNodeCacheResponse_t *)pMsg)->aNwkAddrOfInterest);
      Copy8Bytes(ZbZdoPrivateData(gFindNodeCacheSuccess.aIeeeAddress), ((zbFindNodeCacheResponse_t *)pMsg)->aIeeeAddrOfInterest);
    break;
#endif
    ...
    case gBind_rsp_c:
      ...
      if (ZDP_GetIndexMachineProcessQueue(gInformDevices_c, ZbZdoPrivateData(gZdpResponseCounter)) != gZdoNoEntry_c)
      {
        /* This network address request was orginated by the Bind process the application does not need to know about it */
        MSG_Free(pMsgIn);
        Zdp_UpdateBindResponseStatus(ZDP_GetIndexMachineProcessQueue(gInformDevices_c, ZbZdoPrivateData(gZdpResponseCounter)),
                                    ((zbBindUnbindResponse_t *)pMsg)->status);
        ZDP_StateMachine(gInformDevices_c,ZbZdoPrivateData(gZdpResponseCounter));
        /* Skip the rest of the function */
        return;
      }
#endif
    ...
    case gUnbind_rsp_c:
      ...
      if (ZDP_GetIndexMachineProcessQueue(gReplace_Device_req_c, ZbZdoPrivateData(gZdpResponseCounter)) != gZdoNoEntry_c)
      {
        MSG_Free(pMsgIn);
        ZDP_StateMachine(gReplace_Device_req_c,ZbZdoPrivateData(gZdpResponseCounter));
        return;
      }
#endif
    break;
...
#if gRemove_Bkup_Bind_Entry_req_d
      if (ZDP_GetIndexMachineProcessQueue(gRemove_Bkup_Bind_Entry_req_c, ZbZdoPrivateData(gZdpResponseCounter)) != gZdoNoEntry_c)
      {
        MSG_Free(pMsgIn);
        ZDP_StateMachine(gRemove_Bkup_Bind_Entry_req_c,ZbZdoPrivateData(gZdpResponseCounter));
        return;
      }
#endif
    break;
  ...
  */
  ...
  if ((ZbZdoPrivateData(gZdoInEndDeviceBind) && (clusterId != gEnd_Device_Bind_rsp_c)) &&
...
)
{
  ...
  ZbZdoPrivateData(mbIsNotFree) = TRUE;
...
/*==============================================================================================
  ...
  */
  ...
  if ((ZbZdoPrivateData(gIsABroadcast)) && (pkgPayload[0] != gZbSuccess_c) 
       && (clusterId != gFind_node_cache_req_c))
  {
    ZbZdoPrivateData(gIsABroadcast) = FALSE;
    payloadLength = gZero_c;
  }
  ...
  if (!payloadLength)
  {
    ...
    */
    if (ZbZdoPrivateData(mbIsNotFree))
      MSG_Free( pMsgIn );
...
void Zdo_CnfCallBack(apsdeToAfMessage_t *pMsg)
{
  ...
  */
  if (ZbZdoPrivateData(gMgmtSelfLeaveMask) & zbMgmtOptionSelfLeave_c)
  {
    /*
      If the mask was active then that mean that the local node is the one leving the
      mask does not need to beactive any more.
    */
    ZbZdoPrivateData(gMgmtSelfLeaveMask) &= ~(zbMgmtOptionSelfLeave_c);
...
)
{
  ...
  ZbZdoPrivateData(gIsABroadcast) = pIndication->fWasBroadcast;
  ...
  ZbZdoPrivateData(gZdpResponseCounter) = pIndication->pAsdu[0];
  ...
  if (clusterId & ResponseClusterId)
  {
    ...
    Zdp_ResponseHandler(clusterId, pIndication->pAsdu + sizeof(ZbZdoPrivateData(gZdpResponseCounter)),
                       (pIndication->asduLength - sizeof(ZbZdoPrivateData(gZdpResponseCounter))),pIndication->aSrcAddr);
  }
  else
  {
    if(clusterId == gDevice_annce_c)
    {
      ...
      if(pMsg)
      {
        ...
        FLib_MemCpy(&pMsg->msgData,pIndication->pAsdu + sizeof(ZbZdoPrivateData(gZdpResponseCounter)),pIndication->asduLength);
        (void)ZDP_APP_SapHandler(pMsg);
      }
    }
    /* A request has come over the air we need to generate a response if it is supported */
    Zdp_ResponseGenerator(clusterId, pIndication->pAsdu + sizeof(ZbZdoPrivateData(gZdpResponseCounter)), pIndication->aSrcAddr);
  }
...
)
{
  ...
  */
  ...
  pMessageGoingOut->msgData.dataReq.asduLength = payloadLength + sizeof(ZbZdoPrivateData(gZdpSequence));
  pMessageGoingOut->msgData.dataReq.pAsdu = ((uint8_t *)pMessageGoingOut + (SapHandlerDataStructureOffSet-sizeof(ZbZdoPrivateData(gZdpSequence))));

  /* If it is not a response increase the transaction ID (aka. ZDP sequence number) */
  if (!(clusterId & ResponseClusterId))
  {
    pMessageGoingOut->msgData.dataReq.pAsdu[0] = ZbZdoPrivateData(gZdpSequence)++;
  }
  else
  {
    /* if it is a response use the same sequence number which it came in */
    pMessageGoingOut->msgData.dataReq.pAsdu[0] = ZbZdoPrivateData(gZdpResponseCounter);
  }

  pMessageGoingOut->msgData.dataReq.txOptions = zdoTxOptionsDefault;
  ...
  */
  ...
  /*
    ...
    ones that need it.
  */
  if ((clusterId & ResponseClusterId) && ZbZdoPrivateData(gIsABroadcast))
    pMessageGoingOut->msgData.dataReq.txOptions |= gApsTxOptionAckTx_c;
...
#if gPower_Desc_rsp_d
/*-------------------- Zdp_PowerSourceLevel --------------------*/
uint8_t Zdp_PowerSourceLevel(void)
{
  uint8_t level = (uint8_t)PWRLib_LVD_ReportLevel();
  
  if(level < PWR_BELOW_LEVEL_2_56V)
  {
    return PWR_NODEPOWER_LEVEL_100;
  }
  else if(level < PWR_BELOW_LEVEL_2_1V)
  {
    return PWR_NODEPOWER_LEVEL_66;
  }
  else if(level < PWR_BELOW_LEVEL_1_8V)
  {
...
/*-------------------- ZDP_Mgmt_NWK_Update_req --------------------
*/                                      
void ZDP_Mgmt_NWK_Update_req
(
...
)
{
  ...
  pmsgData = (void *)((uint8_t *)pMsgIn + SapHandlerDataStructureOffSet);
  ...
  Zdp_GenerateDataReq(gMgmt_NWK_Update_req_c,aDestAddress, (afToApsdeMessage_t *)pMsgIn, sizeof(zbMgmtNwkUpdateRequest_t));
...
/*-------------------- ZDP_Mgmt_NWK_Update_Notify --------------------
*/ 
void ZDP_Mgmt_NWK_Update_Notify
(
  zbNwkAddr_t  aDestAddress,
...
)
{
  ...
  /* Memory is freed by the end application */
  afToApsdeMessage_t  *pMsgIn;
  
  uint8_t size = sizeof(zbMgmtNwkUpdateNotify_t) - sizeof(zbEnergyValue_t);
  ...
  pMsgData = (zbMgmtNwkUpdateNotify_t*)((uint8_t*)pMsgIn + ApsmeGetAsduOffset());
  ...
  if (paEnergyVslues)
  {
    ...
    size += iScannedChannelListCount;
  }
  
  Zdp_GenerateDataReq(gMgmt_NWK_Update_notify_c,aDestAddress, (afToApsdeMessage_t *)pMsgIn, size);
  #else
    (void)aDestAddress;
    (void)aScannedChannels;
    (void)iTotalTransmissions;
    (void)iTransmissionFailures;
    (void)iScannedChannelListCount;
    (void)paEnergyVslues;
    (void)status;
  #endif
}
