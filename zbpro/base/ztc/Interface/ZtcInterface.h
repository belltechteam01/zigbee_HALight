...
#define gZtcNonBlockingFunctionality_c TRUE
#endif
...
#define gZTC_RegEpCapability        TRUE
#endif

#ifndef gZtcErrorReporting_d
#define gZtcErrorReporting_d        TRUE
#endif
...
#define gSAPMessagesEnableInterPan_d TRUE
#endif
...
extern uint8_t ztcBeeStackInstId;
/******************************************************************************
*******************************************************************************
* Public prototypes
*******************************************************************************
...
extern void Ztc_Task(uint8_t *pMsg, uint8_t instId);
