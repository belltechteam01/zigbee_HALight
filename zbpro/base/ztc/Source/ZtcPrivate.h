...
#define gUseHwValidation_c TRUE
#endif
...
enum {
  ...
  mZtcOtaSupportSetFileVerPoliciesReq_c           = 0x2D, /* ZTC-OTASuportSetLocalFileVersionPolicies.Request */
  mZtcOtaSuportAbortOTAUpgradeReq_c               = 0x2E, /* ZTC-OTASuportAbortOTAUpgrade.Request*/            
  ...
  mZtcMsgSetApsDeviceKeyPairSetKeyInfo  = 0x40,
  mZtcMsgSetApsOverrideApsEncryption  =   0x41,
  mZtcMsgSetPollRate  =   0x43,
  mZtcMsgSetRejoinConfigParams  =   0x44,
  
  mZtcMsgSetHighLowRamConcentrator    = 0x50,
  
  mZtcMsgEZModeComissioningStart       	= 0x51,
  mZtcMsgZllTouchlinkCommissioningStart_c  = 0x52,
  mZtcMsgZllTouchlinkCommissioningConfigure_c  = 0x53,
  mZtcMsgZllTouchlinkGetListOfCommissionedDevices_c  = 0x54,
  mZtcMsgZllTouchlinkRemoveEntry_c = 0x55,
  
  mZtcMsgClearNeighborTableEntry_c    = 0x56,
  mZtcMsgRemoveDeviceFromPermitJoinTable_c  = 0x80,
  mZtcMsgAddDeviceToPermitJoinTable_c = 0x81,
