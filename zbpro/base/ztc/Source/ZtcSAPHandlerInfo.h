...
extern anchor_t pZtcMlmeNwkInputQueue;     /* MLME_NWK_SapHandler */
extern anchor_t pZtcZdoNlmeInputQueue;     /* ZDO_NLME_SapHandler */
extern anchor_t pZtcApsNldeInputQueue;     /* APS_NLDE_SapHandler */

extern anchor_t pZtcNldeQueue;             /* NLDE_APS_SapHandler */
extern anchor_t pZtcApsmeQueue;            /* ZDO_APSME_SapHandler */
extern anchor_t pZtcApsdeQueue;            /* AF_APSDE_SapHandler */
extern anchor_t pZtcApsToAfdeQ;            /* APSDE_AF_SapHandler */

extern anchor_t pZtcNlmeZdoInputQueue;     /* NLME_ZDO_SapHandler */
extern anchor_t pZtcApsmeZdoInputQueue;       /* APSME_ZDO_SapHandler */
extern anchor_t pZtcAppZdpInputQueue;         /* APP_ZDP_SapHandler */

extern anchor_t pZtcNldeQueue;
extern anchor_t pZtcApsdeQueue;
extern anchor_t pZtcApsmeQueue;

extern anchor_t pZtcApsToAfdeQ;
#ifdef __cplusplus
}
#endif
