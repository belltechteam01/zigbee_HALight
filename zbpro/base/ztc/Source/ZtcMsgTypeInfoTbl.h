...
NwkAspTbl(aspMsgTypeSetPowerLevel_c,      aspMsgTypeSetPowerLevel_c,      gZtcMsgFlagSync_c,    0,                                               gZtcMsgFmtSimple_c         ) /* AspSetPowerLevel.Request     */
NwkAspTbl(aspMsgTypeGetPowerLevel_c,      aspMsgTypeGetPowerLevel_c,      gZtcMsgFlagSync_c,    0,                                               gZtcMsgFmtSimple_c         ) /* AspGetPowerLevel.Request     */
...
NwkAspTbl(aspMsgTypeSetFADState_c,      aspMsgTypeSetFADState_c,      gZtcMsgFlagSync_c,    gUnused_c,                  gZtcMsgFmtSimple_c         ) // Asp_SetFADState.Request
NwkAspTbl(aspMsgTypeGetFADState_c,      aspMsgTypeGetFADState_c,      gZtcMsgFlagSync_c,    gUnused_c,                  gZtcMsgFmtSimple_c         ) // Asp_GetFADState.Request
NwkAspTbl(aspMsgTypeSetFADThreshold_c,  aspMsgTypeSetFADThreshold_c,  gZtcMsgFlagSync_c,    gUnused_c,                  gZtcMsgFmtSimple_c         ) // Asp_SetFADThreshold.Request
NwkAspTbl(aspMsgTypeGetFADThreshold_c,  aspMsgTypeGetFADThreshold_c,  gZtcMsgFlagSync_c,    gUnused_c,                  gZtcMsgFmtSimple_c         ) // Asp_GetFADThreshold.Request
#endif
#undef NwkAspTbl
...
ZtcMsgTbl(mZtcMsgGetApsDeviceKey_c,  ZtcMsgGetApsDeviceKey)
ZtcMsgTbl(mZtcMsgSetApsDeviceKey_c,  ZtcMsgSetApsDeviceKey)
ZtcMsgTbl(mZtcMsgSetApsDeviceKeyPairSetKeyInfo,  ZtcMsgSetApsDeviceKeyPairSetKeyInfo)
...
ZtcMsgTbl(mZtcMsgSetApsOverrideApsEncryption,  ZtcMsgSetApsOverrideApsEncryption)
#endif
ZtcMsgTbl(mZtcMsgSetPollRate,  ZtcMsgSetPollRate)
ZtcMsgTbl(mZtcMsgSetRejoinConfigParams,  ZtcMsgSetRejoinConfigParams)
...
ZtcMsgTbl(mZtcOtaSupportSetModeReq_c,                           ZtcOtaSupportCallback)//ZtcOtaSupportSetModeFunc) 
ZtcMsgTbl(mZtcOtaSupportStartImageReq_c,                        ZtcOtaSupportCallback)//ZtcOtaSupportStartImageReqFunc) 
ZtcMsgTbl(mZtcOtaSupportPushImageChunkReq_c,                    ZtcOtaSupportCallback)//ZtcOtaSupportPushImageChunkReqFunc) 
ZtcMsgTbl(mZtcOtaSupportCommitImageReq_c,                       ZtcOtaSupportCallback)//ZtcOtaSupportCommitImageReqFunc) 
ZtcMsgTbl(mZtcOtaSupportCancelImageReq_c,                       ZtcOtaSupportCallback)//ZtcOtaSupportCancelImageReqFunc) 
ZtcMsgTbl(mZtcOtaSupportSetFileVerPoliciesReq_c,                ZtcOtaSupportCallback)//ZtcOtaSuportSetLocalFileVersionPoliciesFunc) 
ZtcMsgTbl(mZtcOtaSuportAbortOTAUpgradeReq_c,                    ZtcOtaSupportCallback)//ZtcOtaSupportAbortOTAUpgradeFunc)
ZtcMsgTbl(mZtcOtaSupportQueryImageRsp_c,                        ZtcOtaSupportCallback)//ZtcOtaSupportQueryNextImageRspFunc) 
ZtcMsgTbl(mZtcOtaSupportImageNotifyReq_c,                       ZtcOtaSupportCallback)//ZtcOtaSupportImageNotifyFunc)
#endif
*/
...
ZtcMsgTbl(mZtcMsgSetHighLowRamConcentrator,  ZtcMsgSetHighLowRamConcentrator)
#endif
ZtcMsgTbl(mZtcMsgClearNeighborTableEntry_c,  ZtcMsgClearNeighborTableEntry)

#if gASL_EnableEZCommissioning_d
ZtcMsgTbl(mZtcMsgEZModeComissioningStart, ZtcMsgEZComissioning_Start)
#endif
#if gASL_EnableZllTouchlinkCommissioning_d
ZtcMsgTbl(mZtcMsgZllTouchlinkCommissioningStart_c, ZtcMsgZllTouchlinkComissioning_Start)
ZtcMsgTbl(mZtcMsgZllTouchlinkCommissioningConfigure_c, ZtcMsgZllTouchlinkComissioning_Configure)
ZtcMsgTbl(mZtcMsgZllTouchlinkGetListOfCommissionedDevices_c, ZtcMsgZllTouchlink_GetListOfCommissionedDevices)
ZtcMsgTbl(mZtcMsgZllTouchlinkRemoveEntry_c, ZtcMsgZllTouchlink_RemoveEntry)
