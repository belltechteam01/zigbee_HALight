...
#define gMaxBroadcastTransactionTableEntries_c  0x09
#endif
...
#define gNwkAgingTimeForEndDevice_c     5
#endif
...
#define gNwkAgingTimeForRouter_c     10
#endif
...
#define gMinutesToExpireRoute_c     10
#endif
...
#define gNwkInfobaseMaxBroadcastRetries_c       0x02
#endif
...
#define gNwkRoutingMaxRouteDiscoveyTableEntry_c         8
#endif
...
#define gNwkInfobaseMaxSourceRouteTableEntry_c          3
#endif
...
#define gNwkMaxHopsInSourceRoute_c           0x08
#endif
...
/*
  The start-up value of gNwkHighRamConcentrator. Can be changed at runtime. 
  Allows the storing/retrieving source routes. If False, the concentrator 
  does not use the source route table.
  
  Default: FALSE
  Range: bool
*/
#ifndef gNwkHighRamConcentrator_d
#define gNwkHighRamConcentrator_d                 TRUE
#endif
...
#define gHttMaxIndirectEntries_c                        8
#endif
...
#define gNwkMaximumChildren_c     0x14
#endif
...
#define gNwkMaximumDepth_c        0x0F
#endif
...
#define gNwkMaximumRouters_c      0x06
#endif
...
#define gMaxNumberOfTxAttempts_c  0x14
#endif
...
#define gMaxNwkLinkRetryThreshold_c 0x02
#endif
...
#define gICanHearYouTableCapability_d   TRUE
#endif
...
#define gDefaultValueOfMaxEntriesForICanHearYouTable_c  0x04
#endif
...
#define gDefaultValueOfMaxEntriesForExclusionTable_c    0x1
#endif

/*
  Defines how big is going to be the buffer to be used on the Nwk rejoin response state machine.
...
#ifndef gHostApp_d
#define gNwkRejoinStateMachineSize_c  (45)
#else
#define gNwkRejoinStateMachineSize_c  gSmallMsgSize_d
#endif
#endif
...
#define gApsLinkKeySecurity_d  TRUE
#endif

/* 
  If TRUE the APS security information will be cleared upon an Update Device with
  the Device Left status.

  Default: FALSE
*/
#ifndef gApsRemoveLinkKeyOnDeviceLeave_d
#define gApsRemoveLinkKeyOnDeviceLeave_d  FALSE
#endif

/* 
  If TRUE the APS security information, if present, will be cleared when a device
  does an unsecured rejoin. Applies only to the Trust Center.

  Default: FALSE
*/
#ifndef gApsClearSecInfoOnUnsecRejoin_d
#define gApsClearSecInfoOnUnsecRejoin_d  FALSE
#endif
...
#define gFrequencyAgilityCapability_d  TRUE
#endif
...
#define gFragmentationCapability_d  TRUE
#endif
...
#define gNetworkLinkStatusPeriod_c  0x0F
#endif
...
#define gNetworkRouterAgeLimit_c   0x03
#endif
...
#ifndef gNwkSendLinkStatusOnDevAnnc_c
#define gNwkSendLinkStatusOnDevAnnc_c   TRUE
#endif

#ifndef gNwkSmartSiblingReplacement_c
#define gNwkSmartSiblingReplacement_c   TRUE
#endif
/*
  Determines whether or not a remote NWK leave request command frame received
  by the local device is accepted. (ZigBee R20)

  Default: TRUE
*/
#ifndef mDefaultValueOfNwkLeaveRequestAllowed_c
#define mDefaultValueOfNwkLeaveRequestAllowed_c   TRUE
#endif
...
/*
  ...
  The address map is stored in NVM. See gAPS_DATA_SET_FOR_NVM in BeeStack_Globals.h. 
  See also NvDataSetTable in NV_Data.c.
...
/*
  ...
  Groups are stored in NVM. See gAPS_DATA_SET_FOR_NVM in BeeStack_Globals.h. See also 
  NvDataSetTable in NV_Data.c.

  Range:   1 - 255
  Default: 5
*/
#ifndef gApsMaxGroups_c
#define gApsMaxGroups_c                    16
#endif
...
/*
  ...
  The binding table is stored in NVM. See gAPS_DATA_SET_FOR_NVM in BeeStack_Globals.h. 
  See also NvDataSetTable in NV_Data.c.
...
#define gApsMaxDataHandlingCapacity_c           3
#endif
...
#define gExtended_Active_EP_req_d  TRUE
#endif

#ifndef gExtended_Active_EP_rsp_d 
#define gExtended_Active_EP_rsp_d  TRUE
#endif
...
#define gComplex_Desc_req_d  TRUE
#endif

#ifndef gComplex_Desc_rsp_d
#define gComplex_Desc_rsp_d  TRUE
#endif

/* User Discriptor Request Supported */
#ifndef gUser_Desc_req_d
#define gUser_Desc_req_d  TRUE
#endif

#ifndef gUser_Desc_rsp_d
#define gUser_Desc_rsp_d  TRUE
#endif

#ifndef  gDiscovery_Cache_req_d
#define gDiscovery_Cache_req_d  TRUE
#endif

#ifndef gDiscovery_Cache_rsp_d
#define gDiscovery_Cache_rsp_d  TRUE
#endif
...
#define gUser_Desc_set_d  TRUE
#endif

#ifndef gUser_Desc_conf_d
#define gUser_Desc_conf_d  TRUE
#endif

/* System Server Discovery Supported */
#ifndef gSystem_Server_Discovery_req_d
#define gSystem_Server_Discovery_req_d  TRUE
#endif

#ifndef gSystem_Server_Discovery_rsp_d
#define gSystem_Server_Discovery_rsp_d  TRUE
#endif

#ifndef gDiscovery_store_req_d
#define gDiscovery_store_req_d  TRUE
#endif
...
#define gNode_Desc_store_req_d  TRUE
#endif

#ifndef gNode_Desc_store_rsp_d
#define gNode_Desc_store_rsp_d  TRUE
#endif

#ifndef gPower_Desc_store_req_d
#define gPower_Desc_store_req_d  TRUE
#endif

#ifndef gPower_Desc_store_rsp_d
#define gPower_Desc_store_rsp_d  TRUE
#endif

#ifndef gActive_EP_store_req_d
#define gActive_EP_store_req_d  TRUE
#endif

#ifndef gActive_EP_store_rsp_d
#define gActive_EP_store_rsp_d  TRUE
#endif

#ifndef gSimple_Desc_store_req_d
#define gSimple_Desc_store_req_d  TRUE
#endif

#ifndef gSimple_Desc_store_rsp_d
#define gSimple_Desc_store_rsp_d  TRUE
#endif

#ifndef gRemove_node_cache_req_d
#define gRemove_node_cache_req_d  TRUE
#endif
...
#define gFind_node_cache_req_d  TRUE
#endif
...
#define gBind_Register_req_d         TRUE
#endif

#ifndef gBind_Register_rsp_d
#define gBind_Register_rsp_d         TRUE
#endif

#ifndef gReplace_Device_req_d
#define gReplace_Device_req_d        TRUE
#endif

#ifndef gReplace_Device_rsp_d
#define gReplace_Device_rsp_d        TRUE
#endif

#ifndef gStore_Bkup_Bind_Entry_req_d
#define gStore_Bkup_Bind_Entry_req_d  TRUE
#endif

#ifndef gStore_Bkup_Bind_Entry_rsp_d
#define gStore_Bkup_Bind_Entry_rsp_d  TRUE
#endif

#ifndef gRemove_Bkup_Bind_Entry_req_d
#define gRemove_Bkup_Bind_Entry_req_d  TRUE
#endif

#ifndef gRemove_Bkup_Bind_Entry_rsp_d
#define gRemove_Bkup_Bind_Entry_rsp_d  TRUE
#endif

#ifndef gBackup_Bind_Table_req_d
#define gBackup_Bind_Table_req_d      TRUE
#endif

#ifndef gBackup_Bind_Table_rsp_d
#define gBackup_Bind_Table_rsp_d      TRUE
#endif

#ifndef gRecover_Bind_Table_req_d
#define gRecover_Bind_Table_req_d     TRUE
#endif

#ifndef gRecover_Bind_Table_rsp_d
#define gRecover_Bind_Table_rsp_d     TRUE
#endif

#ifndef gBackup_Source_Bind_req_d
#define gBackup_Source_Bind_req_d     TRUE
#endif

#ifndef gBackup_Source_Bind_rsp_d
#define gBackup_Source_Bind_rsp_d     TRUE
#endif

#ifndef gRecover_Source_Bind_req_d
#define gRecover_Source_Bind_req_d    TRUE
#endif

#ifndef gRecover_Source_Bind_rsp_d
#define gRecover_Source_Bind_rsp_d    TRUE
#endif

#ifndef gMgmt_NWK_Disc_req_d
#define gMgmt_NWK_Disc_req_d  TRUE
#endif

#ifndef gMgmt_NWK_Disc_rsp_d
#define gMgmt_NWK_Disc_rsp_d  TRUE
#endif
...
#define gMaximumBindingCacheTableList_c    gMaximumApsBindingTableEntries_c  /* The binding cache table size */
#endif
#endif
