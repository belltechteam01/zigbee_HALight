...
/* 053474r20 ZigBee Pro spec Table 2.26 APS Sub-layer Status Values. */
...
/* 053474r20 ZigBee Pro spec Table 3.57 NWK Layer Status Values (Continued) */
...
/* 053474r20 ZigBee Pro spec Table 2.137 ZDP Enumerations Description. */
/********** 0x01 - 0x7F RESERVED. **********/
...
/* Network layer Constants ( 053474r20 ZigBee Pro spec - Table 3.43 ) */
...
/* Network IB Attributes. ( 053474r20 ZigBee Pro spec - Table 3.44 ) */
...
#define  gNwkLeaveRequestAllowed_c              0xAA
...
/* AIB Security Attributes ( 053474r20 ZigBee Pro spec - Table 4.36 ) */
...
/* AIB Attributes ( 053474r20 ZigBee Pro spec - Table 2.24 ) */
...
/* 053474r20 ZigBee Pro spec Table 3.42 Status Code for Network Status Command Frame */
...
/* See NLME-JOIN.request, Table 3.17, 053474r20 ZigBee Pro spec */
...
typedef PACKED_STRUCT nwkHeader_tag
{
...
typedef PACKED_STRUCT npduFrame_tag
{
	nwkHeader_t  nwkHr;
	uint8_t  pNwkPayload[1];
}npduFrame_t;

/* PACKED_STRUCT used to store the device EA information */
typedef PACKED_STRUCT zbEAReqData_tag{
  zbNwkAddr_t   aSourceAddress;
...
/* Network Discovery  */
typedef PACKED_STRUCT nlmeNetworkDiscoveryReq_tag
{
...
/* Network Formation */
typedef PACKED_STRUCT nlmeNetworkFormationReq_tag
{
  zbChannels_t aScanChannels;
  uint8_t scanDuration;
  uint8_t beaconOrder;
...
/* Permit Joining */
typedef PACKED_STRUCT nlmePermitJoiningReq_tag
{
...
/* Start Router */
typedef PACKED_STRUCT nlmeStartRouterReq_tag
{
  uint8_t   beaconOrder;
  uint8_t   superframeOrder;
  bool_t    batteryLifeExtension;
...
/* Join */
typedef PACKED_STRUCT nlmeJoinReq_tag
{
  ...
  /*
    053474r20 ZigBee Pro spec - Table 3.17 NLME-JOIN.request Parameters
    Name: SecurityEnalbe.
    Type: Boolean
    Range: True or Flase.
 ...
 /* Direct Join */
typedef PACKED_STRUCT nlmeDirectJoinReq_tag
{
  zbIeeeAddr_t aDeviceAddress;
  uint8_t capabilityInformation;
}nlmeDirectJoinReq_t;

/* NLME-LEAVE.request Parameters ( 053474r20 ZigBee Pro spec - Table 3.22 ) */
typedef PACKED_STRUCT nlmeLeaveReq_tag
{
...
/* Sync */
typedef PACKED_STRUCT nlmeSyncReq_tag
{
  bool_t track;
}nlmeSyncReq_t;

/* Get,Set,Reset structure definitions */
typedef PACKED_STRUCT nlmeGetReq_tag
{
...
typedef PACKED_STRUCT nlmeGetNibAttr_tag
{
  uint8_t nibAttributeId;
  uint8_t aNibValue[2];
}nlmeGetNibAttr_t;

typedef PACKED_STRUCT nlmeSetReq_tag
{
  uint8_t  nibAttribute;
  uint8_t  nibAttributeLength;
...
typedef PACKED_STRUCT nlmeChagePollTimer_tag
{
  uint16_t  pollTimeInterval;
}nlmeChagePollTimer_t;

typedef PACKED_STRUCT nlmeResetReq_tag
{
  uint8_t   fFullReset;
} nlmeResetReq_t;
...
*/
typedef PACKED_STRUCT nlmeRouteDiscoveryReq_tag {
...
/*
  ...
  discovery. See NLME-ROUTE-DISCOVERY.Confirm, 053474r20 ZigBee Pro spec Section 3.2.2.32
*/
typedef PACKED_STRUCT nlmeRouteDiscoveryConf_tag{
	zbStatus_t status;
...
*/
typedef PACKED_STRUCT nlmeEnergyScanReq_tag
{
  zbChannels_t aScanChannels;
  uint8_t scanDuration;
}nlmeEnergyScanReq_t;
...
*/ 
typedef PACKED_STRUCT nlmeEnergyScanCnf_tag {
  uint8_t  status;
  uint8_t  scanType;
...
*/
typedef PACKED_STRUCT nlmeSetChannelReq_tag
{
  uint8_t  Channel;
}nlmeSetChannelReq_t;
...
typedef PACKED_STRUCT networkDesc_tag
{
	uint8_t  aPanId[2];
...
typedef PACKED_STRUCT nlmeNetworkDiscoveryConf_tag
{
...
typedef PACKED_STRUCT nlmeNetworkFormationConf_tag
{
  uint8_t status;
  ...
  /* Permit Joining Conf */
typedef PACKED_STRUCT nlmePermitJoiningConf_tag
{
  uint8_t status;
  ...
  /* Start Router Conf */
typedef PACKED_STRUCT nlmeStartRouterConf_tag
{
  uint8_t status;
...
typedef PACKED_STRUCT nlmeJoinIndication_tag
{
  ...
  /* nlme Join Conf */
typedef PACKED_STRUCT nlmeJoinConf_tag
{
...
typedef PACKED_STRUCT nlmeDirectJoinConf_tag
{
...
typedef PACKED_STRUCT nlmeLeaveIndication_tag
{
  zbIeeeAddr_t  aDeviceAddress;
  bool_t rejoin;
  ...
  /* nlme Leave Conf */
typedef PACKED_STRUCT nlmeLeaveConf_tag
{
  uint8_t aDeviceAddress[8];
  uint8_t status;
}nlmeLeaveConf_t;
  ...
  /* nlme Reset Conf */
typedef PACKED_STRUCT nlmeResetConf_tag
{
  uint8_t status;
}nlmeResetConf_t;

  /* nlme Sync Conf */
typedef PACKED_STRUCT nlmeSyncConf_tag
{
  uint8_t status;
}nlmeSyncConf_t;

  /* nlme Get Conf */
typedef PACKED_STRUCT nlmeGetConf_tag
{
  uint8_t  status;
  uint8_t  nibAttribute;
	uint8_t  nibAttributeLength;
  ...
  /* nlme Set Conf */
typedef PACKED_STRUCT nlmeSetConf_tag
{
	uint8_t  status;
  uint8_t  nibAttribute;
}nlmeSetConf_t;

/* 053474r20 ZigBee Pro spec Table 3.2 NLDE-DATA.request Parameters */
typedef PACKED_STRUCT nldeDataReq_tag
{
  zbAddrMode_t dstAddrMode;
...
/* 053474r20 ZigBee Pro spec Table 3.4 NLDE-DATA.indication Parameters */
typedef PACKED_STRUCT nldeDataIndication_tag
{
	zbAddrMode_t  dstAddrMode;
...
/* 053474r20 ZigBee Pro spec Table 3.33 NLME-NWK-STATUS.indication Parameters */
typedef PACKED_STRUCT nlmeNwkStatusIndication_tag
{
...
typedef PACKED_STRUCT nlmeNwkTxReport_tag
{
  uint16_t  TxAttempts;
  uint16_t  TxFailures;
}nlmeNwkTxReport_t;

/* 053474r20 ZigBee Pro spec - Section 3.6.7 NWK Information in the MAC Beacons */
typedef PACKED_STRUCT beaconPayloadData_tag
{
  uint8_t protocolId;
...
* 053474r20 ZigBee Pro spec - Table 3.48 Neighbor Table Entry Format Format
**********************************************************************************/
...
053474r20 ZigBee Pro spec, Table 3.40 NWK Command Frames */
...
typedef PACKED_STRUCT rejoinRequestCommand_tag
{
...
typedef PACKED_STRUCT rejoinResponseCommand_tag
{
	commandId_t  commandFrameIdentifier;
...
typedef PACKED_STRUCT rejoinResponseReq_tag
{
	commandId_t  commandFrameIdentifier;
	zbNwkAddr_t shortAddress;
	uint8_t  rejoinStatus;
...
/* Network Status Command Frame (053474r20 ZigBee Pro spec section 3.4.3)*/
typedef PACKED_STRUCT networkStatusCommand_tag
{
	commandId_t     commandFrameIdentifier;
...
typedef PACKED_STRUCT networkStatusCommandReq_tag
{
	zbNwkAddr_t     aDestinationAddress;
	nwkStatusCode_t statusCode;
...
typedef PACKED_STRUCT networkReportCommand_tag
{
	commandId_t commandFrameIdentifier;
...
/*
  ZigBee spec. 053474r20 ZigBee Pro spec sec. 3.4.10
  Network Update Command 
*/
  
typedef PACKED_STRUCT networkUpdateCommand_tag
{
	commandId_t commandFrameIdentifier;
...
/*
  ZigBee spec. 053474r20 ZigBee Pro spec sec. 3.4.8
  Link Status Command 
*/
typedef uint8_t linkStatusCommandOption_t;
typedef uint8_t statusLink_t;

typedef PACKED_STRUCT linkStatusList_tag
{
  zbNwkAddr_t shortAddress;
  statusLink_t statusLink;
} linkStatusList_t;

typedef PACKED_STRUCT linkStatusCommand_tag
{
	commandId_t commandFrameIdentifier;
...
typedef PACKED_STRUCT sourceRouteSubFrameField_tag
{
  uint8_t relayCount;
  uint8_t relayIndex;
...
typedef PACKED_STRUCT routeRecordCommand_tag
{
  commandId_t commandFrameIdentifier;
  uint8_t relayCount;
  RouteRecordRelayList_t relayList[1]; 
...
enum
{
  ...
  gApsTxOptionIncludeExtNonce_c  =  (1<<4),  /* Include extended nonce in APS security frame */
...
*/
typedef PACKED_UNION zbApsAddr_tag {
...
typedef PACKED_STRUCT zbTxFragmentedHdr_tag {
  uint8_t iMsgType;              /* see primAfToApsde_t */
  PACKED_STRUCT zbTxFragmentedHdr_tag * pNextDataBlock;
  uint8_t iDataSize;
} zbTxFragmentedHdr_t;

/* this header is in each fragmented MsgBuffer, both on TX and RX sides */
/* note: ZTC_FragEventMonitor() requires these two structurs start with same 2 fields */
typedef PACKED_STRUCT zbRxFragmentedHdr_tag {
  uint8_t iMsgType;              /* see primApsdeToAf_t */
  PACKED_STRUCT zbRxFragmentedHdr_tag * pNextDataBlock;
  uint8_t iDataSize;
  uint8_t *pData;
...
/* 
  APSDE-DATA.request parameters. See Table 2.2 in 053474r20 ZigBee Pro spec.
...
*/
typedef PACKED_STRUCT zbApsdeDataReq_tag {
...
/* 
  ZigBee data confirm primitive. See Table 2.3 in 053474r20 ZigBee Pro spec.
...
*/
typedef PACKED_STRUCT zbApsdeDataConfirm_tag
{
...
/*
  ZigBee data indication primitive.  See Table 2.4 in 053474r20 ZigBee Pro spec.
  
  This is received when another node has sent data to this node using 
  AF_DataRequest().
*/
typedef PACKED_STRUCT zbApsdeDataIndication_tag
{
	zbAddrMode_t    dstAddrMode;    /* address mode */
...
/*
  ...
  binding table.
*/
typedef PACKED_STRUCT zbApsmeBindReq_tag {
...
typedef PACKED_STRUCT zbAddressMap_tag{
...
*/
typedef PACKED_STRUCT zbApsmeAddGroupReq_tag {
...
*/
typedef PACKED_STRUCT zbApsmeAddGroupCnf_tag {
  zbStatus_t status;
  zbGroupId_t aGroupId;
  zbEndPoint_t endPoint;
...
*/
typedef PACKED_STRUCT zbApsmeRemoveGroupReq_tag {
  zbGroupId_t aGroupId;
  zbEndPoint_t endPoint;
...
*/
typedef PACKED_STRUCT zbApsmeRemoveGroupCnf_tag{
  zbStatus_t status;
  zbGroupId_t aGroupId;
  zbEndPoint_t endPoint;
...
*/
typedef PACKED_STRUCT zbApsmeRemoveAllGroupsReq_tag{
  zbEndPoint_t endPoint;
...
*/
typedef PACKED_STRUCT zbApsmeRemoveAllGroupsCnf_tag{
  zbStatus_t status;
  zbEndPoint_t endPoint;
...
/*
  ...
  See 053474r20 ZigBee Pro spec, Section 2.2.5.1, Figure 2.2
*/
typedef PACKED_STRUCT zbApsFrame16Bit_tag
{
...
/*
  ...
  See 053474r20 ZigBee Pro spec, Section 2.2.5.1, Figure 2.2
*/
typedef PACKED_STRUCT zbApsFrameGroup_tag
{
  zbApsFrameControl_t frameControl;
...
/*
  ...
  See 053474r20 ZigBee Pro spec, Section 2.2.5.1, Figure 2.2
*/
typedef PACKED_STRUCT zbApsFrame16BitFragmented_tag
{
  zbApsFrameControl_t frameControl;
  zbEndPoint_t  dstEndPoint;
  zbClusterId_t aClusterId;
...
/*
  ...
  See 053474r20 ZigBee Pro spec, Section 2.2.5.1, Figure 2.2
*/
typedef PACKED_STRUCT zbApsFrameCmd_tag
{
  zbApsFrameControl_t frameControl;
  zbApsCounter_t      apsCounter;   /* aka transaction ID or sequence # */
} zbApsFrameCmd_t;
...
/*
  ...
  See 053474r20 ZigBee Pro spec, Section 2.2.5.1, Figure 2.2
*/
typedef PACKED_STRUCT zbApsAckFrame_tag
{
  zbApsFrameControl_t frameControl;
  zbEndPoint_t  dstEndPoint;
  zbClusterId_t aClusterId;
...
/*
  ...
  See 053474r20 ZigBee Pro spec, Section 2.2.5.1, Figure 2.2
*/
typedef PACKED_STRUCT zbApsAckFragmentedFrame_tag
{
  zbApsFrameControl_t frameControl;
  zbEndPoint_t  dstEndPoint;
  zbClusterId_t aClusterId;
...
typedef PACKED_STRUCT zbApsDuplicateRejectionTable_tag
{
...
typedef PACKED_STRUCT zbClusterList_tag
{
	zbCounter_t   cNumClusters;
	zbClusterId_t aClusterList[1];
}zbClusterList_t;

typedef PACKED_STRUCT zbPtrClusterList_tag
{
	zbCounter_t  cNumClusters;
...
*/
typedef PACKED_STRUCT zbNwkAddrRequest_tag
{
...
typedef PACKED_STRUCT zbIeeeAddrRequest_tag
{
...
/********************/
typedef PACKED_STRUCT zbSingleDevResp_tag
{
	zbIeeeAddr_t  aIeeeAddrRemoteDev;
	zbNwkAddr_t  aNwkAddrRemoteDev;
}zbSingleDevResp_t;

typedef PACKED_STRUCT zbExtendedDevResp_tag
{
	zbIeeeAddr_t  aIeeeAddrRemoteDev;
	zbNwkAddr_t  aNwkAddrRemoteDev;
...
*/
typedef PACKED_STRUCT  zbAddressResponse_tag
{
	zbStatus_t  status;
	union{
...
typedef PACKED_STRUCT zbEndDeviceAnnounce_tag
{
...
*/
typedef PACKED_STRUCT zbUserDescriptorPkg_tag
{
	zbSize_t  length;
...
*/
typedef PACKED_STRUCT zbUserDescriptorSet_tag
{
	zbNwkAddr_t  aNwkAddrOfInterest;
	zbUserDescriptorPkg_t  descriptor;
}zbUserDescriptorSet_t;

typedef PACKED_STRUCT zbUserDescriptorConfirm_tag
{
	zbStatus_t  status;
	zbNwkAddr_t  aNwkAddrOfInterest;
...
*/
typedef PACKED_STRUCT zbUserDescriptorRequest_tag
{
	zbNwkAddr_t  aNwkAddrOfInterest;
}zbUserDescriptorRequest_t;

typedef PACKED_STRUCT zbUserDescriptorResponse_tag
{
	zbStatus_t  status;
	zbNwkAddr_t  aNwkAddrOfInterest;
	zbUserDescriptorPkg_t  descriptor;
...
typedef PACKED_STRUCT zbPowerDescriptor_tag
{
...
typedef PACKED_STRUCT zbPowerDescriptorRequest_tag
{
	zbNwkAddr_t  aNwkAddrOfInterest;

}zbPowerDescriptorRequest_t;

typedef PACKED_STRUCT zbPowerDescriptorResponse_tag
{
	zbStatus_t  status;
	zbNwkAddr_t  aNwkAddrOfInterest;
...
typedef PACKED_STRUCT zbPowerDescriptorStoreRequest_tag
{
	zbNwkAddr_t  aNwkAddress;
	zbIeeeAddr_t  aIeeeAddress;
	zbPowerDescriptor_t  powerDescriptor;
...
typedef PACKED_STRUCT zbPowerDescriptorStoreResponse_tag
{
	zbStatus_t  status;
}zbPowerDescriptorStoreResponse_t;

typedef PACKED_STRUCT zbActiveEPStoreRequest_tag
{
...
typedef PACKED_STRUCT zbActiveEPStoreResponse_tag
{
	zbStatus_t  status;
...
typedef PACKED_STRUCT zbComplexDescriptor_tag
{
    /*Field Count*/
    uint8_t fieldCount;
...
typedef PACKED_STRUCT zbComplexDescriptorRequest_tag
{
	zbNwkAddr_t  aNwkAddrOfInterest;
}zbComplexDescriptorRequest_t;

typedef PACKED_STRUCT zbComplexDescriptorResponse_tag
{
	zbStatus_t  status;
	zbNwkAddr_t  aNwkAddrOfInterest;
	zbSize_t  length;
...
typedef PACKED_STRUCT zbDiscoveryStoreRequest_tag  /* mn */
{
	zbNwkAddr_t  aNwkAddress; /* The network address of the device */
	zbIeeeAddr_t  aIeeeAddress; /* The extended address of the device */
...
typedef PACKED_STRUCT zbDiscoveryStoreResponse_tag  /* mn */
{
 ...
 **************************************/
typedef PACKED_STRUCT zbNodeDescriptor_tag
{
	/*Logical Type*/
	uint8_t		logicalType;
...
typedef PACKED_STRUCT zbNodeDescriptorStoreRequest_tag  /* mn */
{
	zbNwkAddr_t  aNwkAddress; /* The network address of the device */
	zbIeeeAddr_t  aIeeeAddress; /* The extended address of the device */
...
typedef PACKED_STRUCT zbNodeDescriptorStoreResponse_tag  /* mn */
{
	zbStatus_t  status; /* the status of the request */
}zbNodeDescriptorStoreResponse_t;

typedef  PACKED_STRUCT  zbNodeDescriptorRequest_tag
{
	zbNwkAddr_t  aNwkAddrOfInterest;
}zbNodeDescriptorRequest_t;

typedef  PACKED_STRUCT  zbNodeDescriptorResponse_tag
{
	zbStatus_t  status;
	zbNwkAddr_t  aNwkAddrOfInterest;
	zbNodeDescriptor_t  nodeDescriptor;
 ...
 ************************************************/
typedef PACKED_STRUCT zbDiscoveryCacheRequest_tag
{
	zbNwkAddr_t  aNwkAddress;
	zbIeeeAddr_t  aIeeeAddress;
}zbDiscoveryCacheRequest_t;

typedef PACKED_STRUCT zbDiscoveryCacheResponse_tag
{
	zbStatus_t  status;
...
typedef PACKED_STRUCT zbSystemServerDiscoveryRequest_tag
{
	zbServerMask_t  aServerMask;/* Bit number: (053474r20 ZigBee Pro spec - Sec: 2.3.2.3.10 Server Mask Field)
...
typedef PACKED_STRUCT zbSystemServerDiscoveryResponse_tag
{
 ...
 *****************************************/
typedef PACKED_STRUCT zbSimpleDescriptor_tag
{
	/*End point ID */
	zbEndPoint_t  endPoint;
...
typedef  PACKED_STRUCT  zbSimpleDescriptorPackageStore_tag  /* mn */
{
/*End point ID */
zbEndPoint_t  endPoint;
/*Application Profile ID*/
...
typedef  PACKED_STRUCT  zbSimpleDescriptorPackageResponse_tag
{
	/*End point ID */
	zbEndPoint_t  endPoint;
	/*Application Profile ID*/
...
typedef PACKED_STRUCT zbSimpleDescriptorStoreRequest_tag  /* mn */
{
	zbNwkAddr_t   aNwkAddress; /* The network address of the device */
	zbIeeeAddr_t  aIeeeAddress; /* The extended address of the device */
...
typedef  PACKED_STRUCT  zbSimpleDescriptorStoreResponse_tag  /* mn */
{
	zbStatus_t  status;  /* This status indicates success or some error code */
}zbSimpleDescriptorStoreResponse_t;

typedef PACKED_STRUCT zbRemoveNodeCacheRequest_tag
{
	zbNwkAddr_t  aNwkAddress;
	zbIeeeAddr_t  aIeeeAddress;
}zbRemoveNodeCacheRequest_t;

typedef PACKED_STRUCT zbRemoveNodeCacheResponse_tag
{
	zbStatus_t  status;
}zbRemoveNodeCacheResponse_t;

typedef PACKED_STRUCT  zbSimpleDescriptorRequest_tag
{
	zbNwkAddr_t   aNwkAddrOfInterest;
	zbEndPoint_t  endPoint;
}zbSimpleDescriptorRequest_t;

typedef PACKED_STRUCT  zbExtSimpleDescriptorRequest_tag
{
	zbNwkAddr_t   aNwkAddrOfInterest;
	zbEndPoint_t  endPoint;
	zbIndex_t     startIndex;  
...
typedef PACKED_STRUCT zbSimpleDescriptorResponse_tag
{
	zbStatus_t   status;
	zbNwkAddr_t  aNwkAddrOfInterest;
	zbSize_t     length;
...
typedef PACKED_STRUCT zbExtSimpleDescriptorResponse_tag
{
	zbStatus_t    status;
	zbNwkAddr_t   aNwkAddrOfInterest;
	zbEndPoint_t  endPoint;
 ...
 * Response
 **************************/
typedef PACKED_STRUCT extendedMode_tag
{
	zbIeeeAddr_t  aDstAddress;
	zbEndPoint_t  dstEndPoint;
}extendedMode_t;

typedef PACKED_STRUCT groupMode_tag
{
	zbGroupId_t  aDstaddress;
}groupMode_t;

typedef PACKED_UNION zbBindModeData_tag
{
	extendedMode_t  extendedMode;
	groupMode_t     groupMode;
}zbBindModeData_t;

typedef PACKED_STRUCT zbBindUnbindRequest_tag
{
...
typedef PACKED_STRUCT zbBindUnbindResponse_tag
{
	zbStatus_t  status;
}zbBindUnbindResponse_t;

typedef PACKED_STRUCT zbActiveEpRequest_tag
{
	zbNwkAddr_t  aNwkAddrOfInterest;

}zbActiveEpRequest_t;

typedef PACKED_STRUCT zbExtActiveEpRequest_tag
{
	zbNwkAddr_t  aNwkAddrOfInterest;
  zbIndex_t    startIndex;
}zbExtActiveEpRequest_t;

typedef PACKED_STRUCT zbActiveEpResponse_tag
{
	zbStatus_t  status;
	zbNwkAddr_t  aNwkAddrOfInterest;
...
typedef PACKED_STRUCT zbExtActiveEpResponse_tag
{
	zbStatus_t     status;
	zbNwkAddr_t    aNwkAddrOfInterest;
	zbCounter_t    activeEpCount;
...
*/
typedef PACKED_STRUCT zbEndDeviceBindRequest_tag
{
...
/*
  ...
  engine in the ZigBee coordinator.
*/
typedef PACKED_STRUCT zbEndDeviceBindResponse_tag
{
	zbStatus_t  status;
} zbEndDeviceBindResponse_t;

/******************/
typedef PACKED_STRUCT zbMatchDescriptorRequest_tag
{
	zbNwkAddr_t         aNwkAddrOfInterest;
	zbProfileId_t       aProfileId;
	zbCounter_t  cNumClusters;
...
typedef PACKED_STRUCT zbMatchDescriptorRequestPtr_tag
{
	zbNwkAddr_t         aNwkAddrOfInterest;
	zbProfileId_t       aProfileId;
...
typedef PACKED_STRUCT zbMatchDescriptorResponse_tag
{
	zbStatus_t  status;
	zbNwkAddr_t  aNwkAddrOfInterest;
...
typedef PACKED_STRUCT zbFindNodeCacheRequest_tag  /* mn */
{
...
*******************************************/
typedef PACKED_STRUCT zbFindNodeCacheResponse_tag  /* mn */
{
...
*/
typedef PACKED_STRUCT zbMgmtBindRequest_tag
{
	zbIndex_t  startIndex;
}zbMgmtBindRequest_t;
...
*/
typedef PACKED_STRUCT zbMgmtBindResponse_tag
{
	zbStatus_t          status;
...
typedef PACKED_STRUCT zbBindRegisterRequest_tag  /* ClusterId 0x0023 */
{
	zbIeeeAddr_t  aIeeeAddress;  /* The addrress of the node that whishes to hold its own information */
}zbBindRegisterRequest_t;

typedef PACKED_STRUCT zbBindResgisterResponse_tag  /* ClusterId 0x8023 */
{
...
/*
	Comments
*/
typedef PACKED_STRUCT zbReplaceDeviceRequest_tag  /* ClusterId 0x0024 */
{
...
typedef PACKED_STRUCT zbReplaceDeviceResponse_tag  /* ClusterId 0x8024 */
{
	zbStatus_t  status;  /* The status of the request */
...
typedef PACKED_STRUCT zbStoreBkupBindEntryResponse_tag  /* ClusterId 0x8025 */
{
	zbStatus_t  status;
...
typedef PACKED_STRUCT zbRemoveBackupBindEntryResponse_tag  /* ClusterId 0x8026 */
{
	zbStatus_t  status;
}zbRemoveBackupBindEntryResponse_t;

typedef PACKED_STRUCT zbRecoverBindTableRequest_tag /* ClusterID  0x0028*/
{
	zbIndex16_t  startIndex;
}zbRecoverBindTableRequest_t;

typedef PACKED_STRUCT zbRecoverBindTableResponse_tag  /* ClusterID 0x8028*/
{
	zbStatus_t  status;
...
typedef PACKED_STRUCT zbBackupSourceBindResponse_tag
{
	zbStatus_t  status;
}zbBackupSourceBindResponse_t;

typedef PACKED_STRUCT zbBackupSourceBindRequest_tag
{
...
typedef PACKED_STRUCT zbRecoverSourceBindRequest_tag
{
	zbIndex16_t  StartIndex;
}zbRecoverSourceBindRequest_t;

typedef PACKED_STRUCT zbRecoverSourceBindResponse_tag
{
	zbStatus_t  Status;
	zbCounter16_t  SourceTableEntries;
	zbIndex16_t  StartIndex;
...
typedef PACKED_STRUCT zbBackupBindTableRequest_tag
{
...
typedef PACKED_STRUCT zbBackupBindTableResponse_tag
{
	zbStatus_t  status;
...
/*====================================================*/
typedef PACKED_STRUCT zbMgmtLeaveRequest_tag
{
	zbIeeeAddr_t  aDeviceAddress;
	zbMgmtOptions_t  mgmtOptions;
}zbMgmtLeaveRequest_t;

typedef PACKED_STRUCT zbMgmtLeaveResponse_tag
{
	zbStatus_t  status;
}zbMgmtLeaveResponse_t;

typedef PACKED_STRUCT  zbMgmtDiscoveryCacheList_tag
{
	zbIeeeAddr_t  aIeeeAddress;
	zbNwkAddr_t  aNwkAddress;
}zbMgmtDiscoveryCacheList_t;

typedef PACKED_STRUCT zbMgmtCacheResponse_tag  /* ClusterID 0x8037 */
{
	zbStatus_t  status;
...
typedef PACKED_STRUCT zbMgmtCacheRequest_tag  /* ClusterID 0x0037 */
{
	zbIndex_t  startIndex;
}zbMgmtCacheRequest_t;

typedef PACKED_STRUCT zbOTAFormatNetworkDescriptor_tag
{
	zbIeeeAddr_t  aExtendedPanId;
	uint8_t  logicalChannel;
...
typedef PACKED_STRUCT zbMgmtNwkDiscResponse_tag
{
	zbStatus_t  status;
...
typedef PACKED_STRUCT zbMgmtNwkDiscoveryRequest_tag
{
...
typedef PACKED_STRUCT zbMgmtLqiRequest_tag
{
	zbIndex_t  startIndex;
}zbMgmtLqiRequest_t;

typedef PACKED_STRUCT zbNeighborTableList_tag
{
	zbIeeeAddr_t  aExtendedPanId;
...
typedef PACKED_STRUCT zbMgmtLqiResponse_tag
{
	zbStatus_t  status;
...
typedef PACKED_STRUCT zbMgmtRtgRequest_tag
{
	zbIndex_t  startIndex;
}zbMgmtRtgRequest_t;
...
typedef PACKED_STRUCT zbMgmtDirectJoinRequest_tag
{
	zbIeeeAddr_t  aDeviceAddress;
	macCapabilityInfo_t  capabilityInformation;
}zbMgmtDirectJoinRequest_t;

typedef PACKED_STRUCT zbMgmtDirectJoinResponse_tag
{
	zbStatus_t  status;
}zbMgmtDirectJoinResponse_t;

typedef PACKED_STRUCT zbMgmtPermitJoiningResponse_tag
{
	zbStatus_t  status;
}zbMgmtPermitJoiningResponse_t;

typedef PACKED_STRUCT zbMgmtPermitJoiningRequest_tag
{
...
typedef PACKED_STRUCT zbNwkManagerData_tag{
  uint8_t       nwkUpdateId;
  zbNwkAddr_t   aNwkManagerAddr;
}zbNwkManagerData_t;

typedef PACKED_UNION zbudata_tag{
  uintn8_t      ScanCount;
  zbNwkManagerData_t NwkManagerData;
}zbudata_t;

/* 053474r20 ZigBee Pro spec - Sec. 2.4.3.3.9 Mgmt_NWK_Update_req */
typedef PACKED_STRUCT zbMgmtNwkUpdateRequest_tag
{
  zbChannels_t  aScanChannels;
  uint8_t       ScanDuration;
  zbudata_t     ExtraData;
...
/* 053474r20 ZigBee Pro spec - Sec. 2.4.4.3.9 Mgmt_NWK_Update_notify */
typedef PACKED_STRUCT zbMgmtNwkUpdateNotify_tag
{
  zbStatus_t     Status;
...
typedef PACKED_STRUCT zbInterPanDataReq_tag {
...
typedef PACKED_STRUCT zbInterPanNwkStubHeader_tag {
zbNwkFrameControl_t aFrameControl;
} zbInterPanNwkStubHeader_t;

typedef PACKED_STRUCT npduStubFrame_tag
{
...
typedef PACKED_STRUCT zbInterPanStubApsFrameGroup_tag
{
  zbApsFrameControl_t frameControl;
  zbGroupId_t   aGroupAddr;
  zbClusterId_t aClusterId;
...
typedef PACKED_STRUCT zbInterPanStubApsFrame16Bit_tag
{
  zbApsFrameControl_t frameControl;
  zbClusterId_t       aClusterId;
  zbProfileId_t       aProfileId;
...
typedef PACKED_UNION zbInterPanApsStubHeader_tag
{
...
typedef PACKED_STRUCT zbInterPanDataConfirm_tag
{
  uint8_t         AsduHandle;
  zbStatus_t      status;         /* status of confirm (worked or failed) */
} zbInterPanDataConfirm_t;

typedef PACKED_STRUCT zbInterPanDataIndication_tag
{
...
/*
  053474r20 ZigBee Pro spec table 4.2
  Name: KeySeqNumber
  Type: Octet
  Range: 0x00-0xff
  Default: 0x00
...
/* Elements of the Incoming Frame Counter Descriptor, 053474r20 ZigBee Pro spec table 4.3 */
/*
  053474r20 ZigBee Pro spec table 4.2
  Name: IncomingFrameCounterSet
  Type: Set of incoming frame counter descriptor values, See 053474r20 ZigBee Pro spec table 4.3
  Range: Variable
  Default: Null set
*/
typedef PACKED_STRUCT zbIncomingFrameCounterSet_tag
{
  /*
    Name: SenderAddress
    Type: Device Address
...
/*
  053474r20 ZigBee Pro spec Table 4.28
  Name: Action
  Type: Enum
  Range: 0x00 - 0x02
  values:
...
*/
typedef PACKED_STRUCT zbKeyInfo_tag
{
  /*
    Name: Key Type
    Type: Integer.
...
*****************************************************************************************/
/* 053474r20 ZigBee Pro spec Table 4.1 NIB Security attibutes data types */
...
/*
  053474r20 ZigBee Pro spec Table 4.1
...
/*
  ...
  NIB Id: 0xa1
*/
typedef PACKED_STRUCT zbNwkSecurityMaterialSet_tag
{
  zbKeySeqNumber_t             keySeqNumber;
...
/*
  053474r20 ZigBee Pro spec - Sec. 4.5.1 Auxiliary Frame Header Format, Table 4.23
*/
/* NOTE: The  must be removed when the new secure module gets activated. */
typedef PACKED_STRUCT zbAuxHeader_tag
{
...
/*
  053474r20 ZigBee Pro spec - Table 4.38 Security Levels Available to the NWK, and APS Layers
*/
...
/*
  053474r20 ZigBee Pro spec - Key Id and Key Identifier sub field.
*/
...
/*
  SSP Nonce
*/
typedef PACKED_STRUCT zbNonce_tag
{
  zbIeeeAddr_t                 aSourceAddress;
  zbFrameCounter_t             FrameCounter;
  zbAuxSecurityControlField_t  AuxSecurityControlField;
...
/*
  053474r20 ZigBee Pro spec - Table 4.37 Elements of the Key-Pair Descriptor.
*/
typedef PACKED_STRUCT zbApsDeviceKeyPairSet_tag
{
  /*
    053474r20 ZigBee Pro spec Table 4.37
    Name: DeviceAddress
...
/*
  Table 4.12 KeyType Parameter of the Transport-Key Primitive
*/
typedef PACKED_STRUCT zbTrustCenterKeyData_tag
{
  /*
    Name: ParentAddress
    Type: Device address
...
*/
typedef PACKED_STRUCT zbNetworkKeyData_tag
{
  /*
    Name: KeySeqNumber
    Type: Octet
...
*/
typedef PACKED_STRUCT zbApplicationKeyData_tag
{
  /*
    Name: ParentAddress
    Type: Device Address
...
typedef PACKED_UNION zbTransportKeyData_tag
{
...
*/
typedef PACKED_STRUCT zbApsmeTransportKeyReq_tag
{
    /*
    Name: KeyType
    Type: Integer
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.7.1 APSME-SWITCH-KEY.request
...
*/
typedef PACKED_STRUCT zbApsmeSwitchKeyReq_tag
{
  /*
    Name: DestAddress.
    Type: Device Address.
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.4.1 APSME-UPDATE-DEVICE.request
...
*/
typedef PACKED_STRUCT zbApsmeUpdateDeviceReq_tag
{
  /*
    Name: DestAddress.
    Type: Device Address.
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.5.1 APSME-REMOVE-DEVICE.request
...
*/
typedef PACKED_STRUCT zbApsmeRemoveDeviceReq_tag
{
  /*
    Name: ParentAddress.
    Type: Device Address.
...
typedef PACKED_STRUCT zbApsmeEstablishKeyReq_tag
{
  /*
...
/*
  053474r20 ZigBee Pro spec Sec. - 4.4.2.4 APSME-ESTABLISH-KEY.response
...
*/
typedef PACKED_STRUCT zbApsmeEstablisKeyRsp_tag
{
  /*
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.8.1 APSME-AUTHENTICATE.request
...
*/
typedef PACKED_STRUCT zbApsmeAuthenticateReq_tag
{
  /*
    Name: PartnerAddress.
    Type: Device Address.
...
typedef PACKED_STRUCT zbApsmeCommandFrame_tag
{
  zbApsFrameControl_t  frameControl;
  zbApsCounter_t       apsCounter;
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.9.2.3.1 Trust Center Master or Link Key Descriptor Field
  If the key type field is set to 0 or 4, the key descriptor field shall be formatted as
  shown.
*/
typedef PACKED_STRUCT zbTrustCenterKeyDescriptor_tag
{
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.9.2.3.2 Network Key Descriptor Field
  If the key type field is set to 1, 5 or 6, this field shall be formatted as shown.
*/
typedef PACKED_STRUCT zbNetworkKeyDescriptor_tag
{
  zbKeySeqNumber_t  sequenceNumber;
  zbIeeeAddr_t      destinationAddr;
  zbIeeeAddr_t      sourceAddr;
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.9.2.3.3 Application Master and Link Key Descriptor Field
  If the key type field is set to 2 or 3, this field shall be formatted as shown.
*/
typedef PACKED_STRUCT zbApplicationKeyDescriptor_tag
{
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.9.2.3 Key Descriptor Field
...
*/
typedef PACKED_UNION zbKeyDescriptor_tag
{
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.9.2 Transport-Key Commands
...
*/
typedef PACKED_STRUCT zbApsmeTransportKeyCommand_tag
{
  zbKeyType_t        keyType;
  zbAESKey_t         key;
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.9.3 Update Device Commands
  ...
  Figure 4.12.
*/
typedef PACKED_STRUCT zbApsmeUpdateDeviceCommand_tag
{
  /*
    Name: DestAddress.
    Type: Device Address.
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.9.4 Remove Device Commands
  ...
  Figure 4.13.
*/
typedef PACKED_STRUCT zbApsmeRemoveDeviceCommand_tag
{
  /*
    Name: Child Address.
    Type: Device address.
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.9.6 Switch-Key Commands
...
*/
typedef PACKED_STRUCT zbApsmeSwitchKeyCommand_tag
{
  /*
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.9.5 Request-Key Commands
  The APS command frame used by a device for requesting a key is specified in this
  clause. The optional fields of the APS header portion of the general APS frame
  format shall not be present.
*/
typedef PACKED_STRUCT zbApsmeRequestKeyCommand_tag
{
  /*
    Name: Key Type
    Type: Integer.
...
typedef PACKED_STRUCT zbApsmeSKKECommand_tag
{
  /*
...
typedef PACKED_STRUCT zbApsmeChallengeCommand_tag
{
  /*
    Name: Key Info
    Type: Struct.
...
typedef PACKED_STRUCT zbApsmeMacDataCommand_tag
{
/*
  Name: MAC.
  Type: Device Address.
...
/*
  053474r20 ZigBee Pro spec Sec - 4.4.9.8 Tunnel Commands
...
*/
typedef PACKED_UNION zbApsmeTunnelData_tag
{
  zbApsmeTransportKeyCommand_t  transportkey;
}zbApsmeTunnelData_t;

typedef PACKED_STRUCT zbApsmeTunnelCommand_tag
{
  zbIeeeAddr_t      aDestinationAddress;
...
typedef PACKED_UNION zbApsmeCommandData_tag
{
  zbApsmeTransportKeyCommand_t  transportkey;
...
typedef PACKED_STRUCT zbApsmeCommand_tag
{
  zbApsmeCommandFrame_t  commandFrame;
...
*****************************************************************************************/
/*
  053474r20 ZigBee Pro spec - Table 4.17 TransportKeyData Parameter for a Trust Center Master or Link Key.
*/
typedef PACKED_STRUCT zbApsmeTrustCenterKeyInd_tag
{
  /*
...
/*
  053474r20 ZigBee Pro spec - Table 4.18 TransportKeyData Parameter for a Network Key.
*/
typedef PACKED_STRUCT zbApsmeNwkKeyInd_tag
{
  /*
    Name: KeySeqNumber.
    Type: Octet.
...
/*
  053474r20 ZigBee Pro spec - Table 4.19 TransportKeyData Parameter for an Application Master or Link Key.
*/
typedef PACKED_STRUCT zbApsmeApplicationKeyInd_tag
{
  /*
    Name: ParentAddress.
    Type: Device Address.
...
typedef PACKED_UNION zbTransportKeyIndDescriptor_tag
{
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.3.2 APSME-TRANSPORT-KEY.indication
  The APSME-TRANSPORT-KEY.indication primitive is used to inform the ZDO of the receipt
  of keying material.
*/
typedef PACKED_STRUCT zbApsmeTransportKeyInd_tag
{
  /*
    Name: SrcAddress.
    Type: Device Address.
  ...
  */
  ...
  /*
    ...
    Type: Octet.
    Range: 0x00 - 0x06
    Description: Identifies the type of key material that was be transported; 053474r20 ZigBee Pro spec
                 see Table 4.12.
  */
  zbKeyType_t  keyType;
  ...
  /*
    ...
    Description: The key that was transported along with identification and usage
                 ...
                 parameter as follows:
                                      KeyType = 0x00 see 053474r20 ZigBee Pro spec Table 4.17
                                      KeyType = 0x01 see 053474r20 ZigBee Pro spec Table 4.18
                                      KeyType = 0x02 see 053474r20 ZigBee Pro spec Table 4.20
                                      KeyType = 0x03 see 053474r20 ZigBee Pro spec Table 4.20
                                      KeyType = 0x04 see 053474r20 ZigBee Pro spec Table 4.17
                                      KeyType = 0x05 see 053474r20 ZigBee Pro spec Table 4.18
  */
  zbTransportKeyIndDescriptor_t  keyData;
}zbApsmeTransportKeyInd_t;

/*
  053474r20 ZigBee Pro spec Sec. 4.4.4.2 APSME-UPDATE-DEVICE.indication
  The APSME shall issue this primitive to inform the ZDO that it received an
  update-device command frame.
*/
typedef PACKED_STRUCT zbApsmeUpdateDeviceInd_tag
{
  /*
    Name: SrcAddress.
    Type: Devie Address.
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.7.2 APSME-SWITCH-KEY.indication
  The APSME shall issue this primitive to inform the ZDO that it received a switchkey
  command frame.
*/
typedef PACKED_STRUCT zbApsmeSwitchKeyInd_tag
{
  /*
    Name: SrcAddress.
    Type: Device Address.
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.5.2 APSME-REMOVE-DEVICE.indication
  The APSME shall issue this primitive to inform the ZDO that it received a
  remove-device command frame.
*/
typedef PACKED_STRUCT zbApsmeRemoveDeviceInd_tag
{
  /*
    Name: SrcAddress.
    Type Device Address.
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.6.2 APSME-REQUEST-KEY.indication
  The APSME shall issue this primitive to inform the ZDO that it received a
  request-key command frame.
*/
typedef PACKED_STRUCT zbApsmeRequestKeyInd_tag
{
  /*
    Name: SrcAddress.
    Type: Device Address.
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.2.3 APSME-ESTABLISH-KEY.indication
  ...
  initiator.
*/
typedef PACKED_STRUCT zbApsmeEstablishKeyInd_tag
{
  /*
    Name: InitiatorAddress.
    Type: Device address.
...
/*
  053474r20 ZigBee Pro spec Sec. 4.4.8.3 APSME-AUTHENTICATE.indication
...
*/
typedef PACKED_STRUCT zbApsmeAuthenticateInd_tag
{
  /*
    Name: InitiatorAddress.
    Type: Device Address.
...
/*
  053474r20 ZigBee Pro spec Sec 4.4.2.2 APSME-ESTABLISH-KEY.confirm
...
typedef zbApsmeCnf_t nlmeAuthenticationCnf_t;
  ...
  /*
    053474r20 ZigBee Pro spec - Table 4.10 Mapping of Symmetric-Key Key Agreement Error Conditions to
    Status Codes.
  */
  /*
  ...
  */
  ...
  /*
  053474r20 ZigBee Pro spec Table 4.33 Mapping of Mutual Entity Authentication Error Conditions 
                       to Status Codes.
...
typedef PACKED_UNION zbAspmeIndication_tag
{
...
typedef PACKED_STRUCT zbApsmeZdoIndication_tag
{
...
*/
typedef PACKED_STRUCT zbKeyEstablish_tag
{
  /*
    Name: IsInitiator.
    Type: Boolean.
...
/*
  NOTE: This type is declared here to have it accessible to the Lib and to the APP
*/
typedef PACKED_STRUCT zbEntityAuthentication_tag
{
  /*
    Name: IsInitiator.
    Type: Boolean.
