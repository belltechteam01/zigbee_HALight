...
******************************************************************************/
#if gR20NS_target_d
#include "BeeStackConfigurationR20NS.h"
#elif gR20RS_target_d
#include "BeeStackConfigurationR20RS.h"
#elif gR20RS_ZDO_target_d
#include "BeeStackConfigurationR20RS_ZDO.h"
#else
...
#define gNwkInfobaseMaxRouteTableEntry_c              25
#endif
...
#define gNwkMaxHopsInSourceRoute_c           0x0C
#endif
...
#define gConcentratorFlag_d                       FALSE
#endif
...
*/
  ...
  #else 
    #define gNwkMaximumDepth_c        0x05
  #endif
#endif
...
#define gMaxNwkLinkRetryThreshold_c 0x06
#endif
...
#ifndef gNwkSecSaveIncomingCounters_c
#define gNwkSecSaveIncomingCounters_c        TRUE
#endif
...
#define gApsClearSecInfoOnUnsecRejoin_d  TRUE
#endif
...
/*
  ...
  Default: FALSE  
  IMPORTANT: This capability is only mandatory for ZC so it is set to TRUE for 
