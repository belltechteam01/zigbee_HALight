...
#undef gMaximumApsBindingTableEntries_c
#define gMaximumApsBindingTableEntries_c 1
#endif

#if !gApsAckCapability_d
#undef gApsMaxDataHandlingCapacity_c
#define gApsMaxDataHandlingCapacity_c 1
#endif
...
/*
  053474r20 ZigBee Pro spec Table 3.44 NIB Attributes
