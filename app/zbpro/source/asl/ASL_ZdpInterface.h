...
void ASL_GenerateNwkDiscoveryReq( uint32_t aScanChannels, uint8_t scanDuration);
void ASL_GenerateDirectJoinReq(zbIeeeAddr_t aDeviceAddress, uint8_t capabilityInformation);
