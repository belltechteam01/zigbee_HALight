...
zclStatus_t ASL_ZclUpdateCommissioningStateReq(zclUpdateCommissioningStateReq_t *pReq);
#else
#define ASL_ZclUpdateCommissioningStateReq(pReq) FALSE
#endif

#if gASL_ZclCmdEzModeInvokeReq_d
zclStatus_t ASL_ZclEzModeInvokeReq(zclEzModeInvokeReq_t *pReq);
#else
#define ASL_ZclEzModeInvokeReq(pReq) FALSE
#endif
...
#if gASL_EnableZLLClustersData_d 
#define ASL_ZclSceneEnhancedAddSceneReq(pReq,len)    FALSE     
#endif  
#endif
...
#if gASL_EnableZLLClustersData_d 
#define ASL_ZclEnhancedViewSceneReq(pReq) FALSE 
#endif
#endif
...
/*-------------------- ASL_ZclEnhancedViewSceneReq --------------------
  ...
  Returns gZbSuccess_t if worked.
 */
zbStatus_t ASL_ZclSceneCopySceneReq(zclSceneCopyScene_t *pReq);
#else
#define ASL_ZclSceneCopySceneReq(pReq)  FALSE
#endif
...
/*-------------------- ASL_ZclDoorLock_ClearCmdsReq --------------------
	10.1.2.15.1 LockDoor, 10.1.2.15.2 UnlockDoor, 10.1.2.15.3 Toggle 
*/
...
#define ASL_ZclDoorLock_ClearCmdsReq(pReq) FALSE
#endif
