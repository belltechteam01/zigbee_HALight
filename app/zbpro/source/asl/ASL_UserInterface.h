...
#if gTargetTWR_KW22D512_d

/* Invert the LED order to match the switches */
...
#define LED1_FLASH               0x80
#define LED2_FLASH               0x40
#define LED3_FLASH               0x20
#define LED4_FLASH               0x10
...
/* Send to the Test Client any message diplayedon the LCD */
#ifndef gASL_PrintToTestClient_d
#define gASL_PrintToTestClient_d FALSE
#endif
...
void ASL_EZModeCommissioning_ConfigHandleKeys(key_event_t event);
...
typedef PACKED_STRUCT ASL_Data_tag {
...
#else
#define gAppModeDisplay       gAslData[zbProInstance].appModeDisplay
#define gConfigModeDisplay    gAslData[zbProInstance].configModeDisplay
#define gAppSettingDisplay    gAslData[zbProInstance].appSettingDisplay
#define appState              gAslData[zbProInstance].appState
#define PermitJoinStatusFlag  gAslData[zbProInstance].PermitJoinStatusFlag
#define gmAslChannelNumber    gAslData[zbProInstance].channelNumber
#define gSendingNwkData       gAslData[zbProInstance].sendingNwkData
#endif
...
extern  uint8_t gmUserInterfaceMode;
#else
extern   ASL_Data_t gAslData[2];
extern   uint8_t gmUserInterfaceMode[2];
#endif
