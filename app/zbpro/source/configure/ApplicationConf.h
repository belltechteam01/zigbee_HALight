...
/*
  ...
  network. Default = 0x00008000 = channel 15.(Default SecondPan = 0x02000000 = channel 25) 
  The channel list is a bitmap, where each  bit describes a channel 
  (for example bit 12 corresponds to channel 12). Any combination 
...
*/
  ...
  #define mDefaultValueOfChannel_c         0x00080000
#endif

/* The default channel list for second pan - used in dual pan applications */ 

#ifndef mDefaultValueOfChannelPan2_c
  #define mDefaultValueOfChannelPan2_c     0x02000000
#endif
...
*/
  ...
  #define gFullChannelList_c         0x00000000
#endif
...
*/
  ...
  #define mDefaultValueOfPanId_c				   0xff,0xff
#endif

/* PAN ID for second pan - used in dual pan applications */  
#ifndef mDefaultValueOfPanId2_c
  #define mDefaultValueOfPanId2_c                  0xff,0xff
#endif
...
*/
  ...
  #define mDefaultValueOfExtendedAddress_c		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
#endif
...
#define mDefaultValueOfAuthenticationPollTimeOut_c  0x00C8
#endif
...
#define mDefaultValueOfConfirmationPollTimeOut_c  0x00C8
#endif
...
#define mDefaultValueOfAuthTimeOutDuration_c     0x00001388
#endif
...
/*
  If mDefaultValueOfTrustCenterLinkKey_c is all zeros and gSKKESupported_d is FALSE the mDefaultGlobalTrustCenterLinkKey_c
  ("ZigBeeAlliance09" in little endian) will be used as the Trust Center Link Key. (ZigBee R20)
*/
#ifndef mDefaultGlobalTrustCenterLinkKey_c
#define mDefaultGlobalTrustCenterLinkKey_c 0x5A,0x69,0x67,0x42,0x65,0x65,0x41,0x6C,0x6C,0x69,0x61,0x6E,0x63,0x65,0x30,0x39
#endif                                        
/* 
  ZLL Certification Pre - Installed Link Key Index
*/
#ifndef mDefaultZllCertPreinstalledLinkKeyIndex_c
#define mDefaultZllCertPreinstalledLinkKeyIndex_c     0x01
#endif
/*
  ZLL Certification Pre - Installed Link Key
*/
#ifndef mDefaultZllCertificationPreinstalledLinkKey_c
#define mDefaultZllCertificationPreinstalledLinkKey_c 0xD0,0xD1,0xD2,0xD3,0xD4,0xD5,0xD6,0xD7,0xD8,0xD9,0xDA,0xDB,0xDC,0xDD,0xDE,0xDF
#endif 
/*
...
*/
  ...
  #define mDefaultValueOfApplicationKeyType_c  0x02
#endif

/*
  Default value of the Trust Center IEEE address.

  If set to all zeros the Trust Center IEEE address will be set to the source
  address included in the first Transport Key command received.
*/
#ifndef mDefaultValueOfTrustCenterLongAddress_c
  #define mDefaultValueOfTrustCenterLongAddress_c  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
#endif
...
*/
  ...
  #define mDefaultApsSecurityTimeOutPeriod_c  0x000007D0
#endif
...
#define gIeeeFilterValue_c      0x00,0x00,0x00,0x00,0x00,0x11,0x11,0x11
#endif


/*
  How long to wait for the 2nd EndDeviceBind.Request? End-device-bind is enabled
  (only on ZigBee coordinators - ZC) by enabling both gEnd_Device_Bind_rsp_d and
...
*/
  ...
  #define mDefaultValueOfEndDeviceBindTimeOut_c   0x00007530
#endif


/*
  How long before end-device-bind process times out? End-device-bind is enabled
  (only on ZigBee coordinators - ZC) by enabling both gEnd_Device_Bind_rsp_d and
  gBindCapability_d. Examples:
  ...
  Default: 0x00002710 (10000ms = 10 seconds)
*/
#ifndef mDefaultValueOfEndDeviceBindProcessTimeOut_c
  #define mDefaultValueOfEndDeviceBindProcessTimeOut_c   0x00007530
#endif
...
*/
  ...
  #define mDefaultValueOfNwkSecurityLevel_c   0x05
#endif
...
*/
  ...
  #define mDefaultValueOfNwkUseMulticast_c  FALSE
#endif
...
/*
  ...
  Default: 0x1004 (0x04, 0x10)  
*/
#ifndef mDefaultValueOfManfCodeFlags_c
  #define mDefaultValueOfManfCodeFlags_c            0x04,0x10
#endif
...
*/
  ...
  #define mDefaultValueOfNwkScanAttempts_c        0x03
#endif
...
*/
  ...
  #define mDefaultValueOfNwkTimeBwnScans_c            0x0064
#endif
...
*/
  ...
  #define mDefaultValueOfRejoinInterval_c 0x0002
#endif
...
*/
  ...
  #define mDefaultValueOfMaxRejoinInterval_c 0x0e10
#endif
...
*/
  ...
  #define mDefaultValueOfNwkDiscoveryAttempts_c   0x00
#endif
...
*/
  ...
  #define mDefaultValueOfDiscoveryAttemptsTimeOut_c		0x00000
#endif
...
*/
  ...
  #define mDefaultValueOfNwkFormationAttempts_c   0x00
#endif
...
*/
  ...
  #define mDefaultValueOfFormationAttemptsTimeOut_c   0x0000
#endif
...
*/
  ...
  #define mDefaultValueOfNwkOrphanScanAttempts_c  0x00
#endif 
...
*/
  ...
  #define mDefaultValueOfOrphanScanAttemptsTimeOut_c	0x00000000
#endif
...
#define  mNwkRptConstantCost_c									0x00
#endif
...
#define  mNwkRouteDiscRetriesPermitted_c        0x03
#endif
...
#define mDefaultValueOfComplexDescLangCharSet_c     0x01,0x41,0x41,0x00
#endif
...
/*
  The number of minutes the network manager waits to reach the maximum number of
  update notifies(gMaxIncomingErrorReports_c) before initiating the Frequency
  Agility procedure. This has effect on the Network Manager only.
...
/*
  The number of hours the network manager waits after a channel change before
  the FA process can trigger another channel change. This has effect on the
  Network Manager only.

  Range:   1 - 255
  Default: 24
*/
#ifndef  gChannelChangeTimeout_c
#define  gChannelChangeTimeout_c  24
#endif
...
#define gApsMaxFragmentLengthDefault_c               0x3c
#endif
...
#define gDefaultScanDuration_c                       0x05
#endif
...
#define gDefaultScanCount_c                          0x01
#endif
...
#define gConcentratorDiscoveryTime_c                 0x00
#endif
...
#define gApsMaxEntriesForPermissionsTable_c          0x00
#endif
...
#define gMaxRxTxDataLength_c                (192)
#endif
/*****************************************************************************
******************************************************************************
